...
public class RealWorldTest {
    ...
    public void testHomePageLoads() {
        ...
        Assertions.assertTrue(title.toLowerCase().contains("realworld"),
    ...
    public void testInvalidLogin() {
        ...
        By errorMsg = By.cssSelector(".alert");
        ...
        Assertions.assertTrue(msg.contains("unauthorized") || msg.contains("invalid") || msg.contains("wrong"),
    ...
    public void testFooterExternalLinks() {
        navigateToBase();
        By externalLinks = By.xpath("//a[starts-with(@href,'http')]");
