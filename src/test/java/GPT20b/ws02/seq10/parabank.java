...
public class ParabankTests {
    ...
    private static void login() {
        ...
        Assertions.assertTrue(
                driver.getCurrentUrl().contains("accountsummary"),
                "Login did not navigate to account summary page");
    }

    private static void logout() {
        List<WebElement> signOutLinks = driver.findElements(By.linkText("SIGN OUT"));
    ...
    public void testLoginInvalid() {
        ...
        WebElement errorMsg = wait.until(
                ExpectedConditions.visibilityOfElementLocated(By.cssSelector("div.validation")));
        Assertions.assertTrue(
