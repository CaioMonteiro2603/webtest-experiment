...
public class bugbank {
    ...
    public void testValidLogin() {
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(".account-summary, .account-list, [data-testid='account-summary']")));

        assertTrue(driver.getCurrentUrl().contains("dashboard") || driver.getCurrentUrl().contains("accounts"),
                "URL should contain 'dashboard' or 'accounts' after login");
        assertTrue(driver.findElements(By.cssSelector(".account-summary, .account-list, [data-testid='account-summary']")).size() > 0,
                "Account summary should be visible after login");
    ...
    public void testInvalidLogin() {
        ...
        WebElement errorMsg = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".error, .alert, [role='alert']")));
    ...
    public void testMenuNavigation() {
        ...
        // Open burger menu
        By menuButtonLocator = By.cssSelector("[aria-label='Open Menu'], .burger-menu, .navbar-toggler");
    ...
    public void testFooterExternalLinks() {
        ...
        // Twitter
        By twitterLocator = By.cssSelector("a[href*='twitter.com']");
        verifyExternalLink(driver.findElement(twitterLocator), "twitter.com");

        // Facebook
        By facebookLocator = By.cssSelector("a[href*='facebook.com']");
        verifyExternalLink(driver.findElement(facebookLocator), "facebook.com");

        // LinkedIn
        By linkedInLocator = By.cssSelector("a[href*='linkedin.com']");
