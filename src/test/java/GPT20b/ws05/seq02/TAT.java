...
public class TAT {
    ...
    public void testHomePageLoads() {
        ...
        wait.until(ExpectedConditions.titleContains("Central"));
        assertTrue(driver.getTitle().toLowerCase().contains("central"),
                "Title should contain 'central'");
    ...
    public void testBurgerMenuActions() {
        ...
        WebElement burger = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button[aria-label='Menu']")));
        burger.click();
        ...
        for (WebElement link : menuLinks) {
            ...
            switch (txt) {
                ...
                case "Products":
                    ...
                    wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button[aria-label='Menu']")));
