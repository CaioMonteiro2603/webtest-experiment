...
public class saucedemo {
    ...
    private void openBurgerMenu(int menuIndex) {
        ...
        List<WebElement> menuItems = wait.until(
                ExpectedConditions.presenceOfAllElementsLocatedBy(By.cssSelector(".menu-item a, .bm-item-list li a")));
    ...
    void testFooterExternalLinks() {
        ...
        for (String domain : expectedDomains) {
            ...
            Assertions.assertTrue(currentUrl.contains(domain.replace(".com", "")),
    ...
    void testAddRemoveCart() {
        ...
        WebElement firstRemoveBtn = wait.until(
                ExpectedConditions.elementToBeClickable(By.cssSelector("button[id^='remove']")));
    ...
    void testCheckoutFlow() {
        ...
        Assertions.assertEquals("Thank you for your order!".toUpperCase(), completeHeader.getText().trim().toUpperCase(),
