...
public class TAT {
    ...
    public void testHomePageLoads() {
        ...
        Assertions.assertEquals("Central de Atendimento ao Cliente TAT", title.getText(), "Title should match expected header");
    ...
    public void testFileUpload() {
        ...
        Assertions.assertTrue(uploadedFile.getText().contains("testfile.txt"), "Uploaded file name should be shown");
    }
}
