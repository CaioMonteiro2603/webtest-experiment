...
public class AutomationInTestingTest {
    ...
    public void testNavigationToRoomsPage() {
        ...
        WebElement roomContainer = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".room-info")));
    ...
    public void testExternalLinkLinkedIn() {
        ...
        if (linkedinLinks.size() > 0) {
            ...
            Assertions.fail("LinkedIn link not found on the page.");
        }
    }
}
