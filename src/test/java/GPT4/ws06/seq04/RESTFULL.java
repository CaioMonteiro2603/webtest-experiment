...
public class AutomationInTestingTest {
    ...
    public void testHomePageLoads() {
        driver.get(BASE_URL);
        WebElement header = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".hero-title")));
    ...
    public void testNavBookRoomPage() {
        driver.get(BASE_URL);
        WebElement bookRoomBtn = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href='#book']")));
        bookRoomBtn.click();
    ...
    public void testAdminLoginAndLogout() {
        ...
        WebElement roomsHeader = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h2[text()='Rooms']")));
    ...
    public void testFooterVisibilityAndText() {
        ...
        Assertions.assertTrue(footer.getText().toLowerCase().contains("automation in testing"), "Footer does not contain expected text");
    }
}
