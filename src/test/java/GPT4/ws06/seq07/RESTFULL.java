...
public class AutomationInTestingTest {
    ...
    public void testHomePageLoads() {
        driver.get(BASE_URL);
        WebElement header = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("div.hero h1")));
        Assertions.assertEquals("Welcome to Restful-booker", header.getText(), "Hero title should be present");
    ...
    public void testBookRoomNavigation() {
        driver.get(BASE_URL);
        WebElement bookButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button.room-book-button")));
        bookButton.click();
        WebElement form = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("form")));
    ...
    public void testSubmitContactFormSuccess() {
        ...
        WebElement successMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".contact h2")));
    ...
    public void testSubmitContactFormValidationError() {
        driver.get(BASE_URL);
        WebElement submitBtn = wait.until(ExpectedConditions.elementToBeClickable(By.id("submitContact")));
        submitBtn.click();
    ...
    public void testAdminLoginSuccess() {
        ...
        WebElement header = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".row .col-sm-12 h2")));
