...
public class JPetStoreTest {
    ...
    public void testHomePageLoads() {
        driver.get(BASE_URL);
        WebElement welcome = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("div#Welcome h2")));
    ...
    public void testAddItemToCart() {
        ...
        WebElement itemLink = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("FI-SW-01")));
        itemLink.click();
