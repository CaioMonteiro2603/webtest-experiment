...
public class JPETSTORE {
    ...
    public void testSignInLinkOpensLoginPage() {
        ...
        Assertions.assertTrue(driver.getCurrentUrl().contains("/account/login"), "Did not navigate to login page");
    }
    ...
    public void testProductListInFishCategory() {
        ...
        List<WebElement> items = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.cssSelector(".product-grid .product")));
    ...
    public void testAddToCartAndVerifyQuantity() {
        ...
        WebElement addButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("form[action='/cart/add/FI-SW-01'] button")));
        addButton.click();
    ...
    public void testExternalAspectranLink() {
        driver.get(BASE_URL);
        WebElement footerLink = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Aspectran")));
