...
public class BugBankTest {
    ...
    private void ensureLoggedIn() {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.id("user-name"))).sendKeys(USER_EMAIL);
        wait.until(ExpectedConditions.elementToBeClickable(By.id("password"))).sendKeys(USER_PASSWORD);
    ...
    public void testInvalidLogin() {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.id("password"))).sendKeys("badpass");
        wait.until(ExpectedConditions.elementToBeClickable(By.id("login-button"))).click();
