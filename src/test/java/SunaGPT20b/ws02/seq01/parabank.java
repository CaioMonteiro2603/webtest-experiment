...
public class parabank {
    ...
    public void testValidLogin() {
        ...
        Assertions.assertTrue(currentUrl.contains("parabank") && !currentUrl.endsWith("index.htm") && !currentUrl.endsWith("login.htm"),
                "After login the URL should redirect to an internal page and not remain on login.");
    ...
    public void testLogout() {
        ...
        WebElement logoutLink = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//a[contains(@href,'logout.htm')]")));
        logoutLink.click();
