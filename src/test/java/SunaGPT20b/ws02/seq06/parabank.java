...
public class parabank {
    ...
    public void testNavigateToAboutPage() {
        ...
        Assertions.assertEquals("ParaBank Is A Demo Banking Site", header.getText(),
                "About page should have correct header.");
    }
    ...
    public void testNavigateToContactPage() {
        ...
        WebElement header = wait.until(
                ExpectedConditions.visibilityOfElementLocated(By.tagName("h1")));
        Assertions.assertEquals("Customer Care", header.getText(),
                "Contact page should have correct header.");
    }
    ...
    public void testLogout() {
        ...
        WebElement logoutLink = wait.until(
                ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(text(),'Log Out')]")));
        logoutLink.click();
