...
public class JPetStore {
    ...
    public void testInvalidLogin() {
        ...
        WebElement errorMsg = wait.until(ExpectedConditions.presenceOfElementLocated(By.id("error-message")));
    ...
    public void testAddToCartAndCheckout() {
        ...
        // Add to cart
        WebElement addToCartBtn = wait.until(ExpectedConditions.elementToBeClickable(By.name("addToCart")));
        addToCartBtn.click();
        // Verify cart badge count
        WebElement cartBadge = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("cart-count")));
        ...
        WebElement successMsg = wait.until(ExpectedConditions.presenceOfElementLocated(By.id("order-success")));
