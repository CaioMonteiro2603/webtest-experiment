...
public class SaucedemoTestSuite {
    ...
    public void testValidLogin() {
        ...
        List<WebElement> items = driver.findElements(By.className("_item"));
    ...
    public void testSortingDropdown() {
        login(USERNAME, PASSWORD);
        By sortLocator = By.id("sort_container");
        WebElement sortDropdown = wait.until(ExpectedConditions.elementToBeClickable(sortLocator));
        String[] options = {"az", "za", "lohi", "hilo"};
        for (String value : options) {
            sortDropdown.click();
            WebElement option = driver.findElement(By.cssSelector("#sort_container option[value='" + value + "']"));
            option.click();
