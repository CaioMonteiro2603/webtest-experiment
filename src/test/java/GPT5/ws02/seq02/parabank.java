...
public class parabank {
    ...
    public void testInternalNavigationAboutServicesContact() {
        ...
        Assertions.assertTrue(driver.findElements(By.cssSelector("#rightPanel h1")).size() > 0, "About page should have a header");
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("rightPanel")));
        Assertions.assertTrue(driver.findElements(By.cssSelector("#rightPanel h1")).stream()
                .anyMatch(h -> h.getText().toLowerCase().contains("customer care") || 
                              h.getText().toLowerCase().contains("contact")), "Contact page should have a header");
    }
