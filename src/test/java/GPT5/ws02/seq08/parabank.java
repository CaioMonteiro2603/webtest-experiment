...
public class parabank {
    ...
    private void login(String user, String pass) {
        ...
        WebElement u = wait.until(ExpectedConditions.elementToBeClickable(usernameField()));
        u.clear();
        u.sendKeys(user);
    ...
    public void invalidLoginShowsError() {
        ...
        Assertions.assertTrue(driver.getCurrentUrl().contains("index.htm") || driver.getCurrentUrl().equals(BASE_URL), 
                "Should remain on index.htm after invalid login");
    }
    ...
    public void topNav_AboutUs_InternalNavigation() {
        ...
        try {
            ...
            Assertions.assertTrue(h1.getText().toLowerCase().contains("about") || h1.getText().toLowerCase().contains("para"), 
                    "About Us page should have an appropriate header");
        } catch (TimeoutException e) {
            Assertions.assertTrue(driver.getCurrentUrl().contains("about.htm") || driver.getTitle().toLowerCase().contains("about"), 
                    "About Us page should be navigated");
        }
    }
    ...
    public void topNav_Services_InternalNavigation() {
        ...
        try {
            ...
            Assertions.assertTrue(driver.getCurrentUrl().contains("services.htm") || driver.getTitle().toLowerCase().contains("services"), 
                    "Services page should be navigated");
        }
    }
    ...
    public void topNav_Products_InternalNavigation() {
        ...
        products.click();
        boolean isExternal = driver.getCurrentUrl().startsWith("https://www.parasoft.com");
        if (isExternal) {
            Assertions.assertTrue(driver.getCurrentUrl().contains("parasoft.com/products") || driver.getCurrentUrl().contains("parasoft.com/solutions"),
                    "Products link should navigate to external Parasoft products page");
        } else {
            wait.until(ExpectedConditions.or(
            ...
            try {
                ...
                Assertions.assertTrue(driver.getCurrentUrl().contains("products.htm") || driver.getTitle().toLowerCase().contains("products"), 
                        "Products page should be navigated");
            }
        }
    }
    ...
    public void topNav_Locations_InternalNavigation() {
        ...
        boolean isExternal = driver.getCurrentUrl().startsWith("https://www.parasoft.com");
        if (isExternal) {
            Assertions.assertTrue(driver.getCurrentUrl().contains("parasoft.com/solutions") || driver.getCurrentUrl().contains("parasoft.com/locations"),
                    "Locations link should navigate to external Parasoft locations page");
        } else {
            wait.until(ExpectedConditions.or(
            ...
            try {
                ...
                Assertions.assertTrue(driver.getCurrentUrl().contains("locations.htm") || driver.getTitle().toLowerCase().contains("locations"), 
                        "Locations page should be navigated");
            }
        }
    }
