...
public class AutomationInTestingTest {
    ...
    void testPageLoadsSuccessfully() {
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("room-description")));
    ...
    void testContactFormSuccessfulSubmission() {
        ...
        WebElement contactFormHeader = driver.findElement(By.xpath("//h2[text()='Contact']"));
    ...
    void testContactFormErrorOnMissingSubject() {
        ...
        driver.findElement(By.id("name")).sendKeys("Caio Augusto");
        driver.findElement(By.id("email")).sendKeys("caio.augusto@geminipro.com");
        driver.findElement(By.id("phone")).sendKeys("19999999999");
