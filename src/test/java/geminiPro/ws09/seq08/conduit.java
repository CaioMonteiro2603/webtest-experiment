...
public class ConduitAppTest {
    ...
    void testUserRegistration() {
        ...
        assertTrue(wait.until(ExpectedConditions.visibilityOfElementLocated(userProfileLink)).isDisplayed(),
    ...
    void testSuccessfulLoginAndLogout() {
        ...
        By userProfileLink = By.linkText(testUsername);
        assertTrue(wait.until(ExpectedConditions.visibilityOfElementLocated(userProfileLink)).isDisplayed(), "User should be logged in.");
    ...
    void testFilterByTag() {
        ...
        WebElement firstTag = popularTagsSection.findElement(By.cssSelector(".tag-pill"));
        ...
        assertEquals(tagName, activeTab.getText(), "The active tab should show the selected tag name.");
    ...
    void testGitHubExternalLink() {
        ...
        WebElement link = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a.logo-font[href*='github']")));
