...
public class DemoAUT {
    ...
    void initialPageStateTest() {
        // Assert page title
        assertEquals("HTML Form Example", driver.getTitle(), "Page title is incorrect.");
    ...
    void emptyFormSubmissionTest() {
        ...
        // Wait for the page to reload. We can check for a known empty parameter.
        wait.until(ExpectedConditions.urlContains("firstName=&"));
        String currentUrl = driver.getCurrentUrl();

        // Verify that the required parameters are present but empty
        assertTrue(currentUrl.contains("firstName=&"), "Empty firstName parameter is missing.");
        assertTrue(currentUrl.contains("lastName=&"), "Empty lastName parameter is missing.");
        assertTrue(currentUrl.contains("address=&"), "Empty address parameter is missing.");
        assertTrue(currentUrl.contains("email=&"), "Empty email parameter is missing.");
