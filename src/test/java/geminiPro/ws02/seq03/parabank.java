...
public class parabank {
    ...
    private static final By REGISTRATION_SUCCESS_MESSAGE = By.xpath("//*[contains(text(),'Your account was created successfully.')]");
    ...
    void testSuccessfulLoginAndLogout() {
        ...
        Assertions.assertTrue(welcomeTitle.isDisplayed(), "User was not redirected to the Accounts Overview page after login.");
