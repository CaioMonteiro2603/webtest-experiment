...
public class parabank {
    ...
    static void setup() {
        ...
        generatedUsername = "caio@gmail.com";
    ...
    void testUserRegistration() {
        ...
        WebElement accountLink = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[contains(@href, 'activity.htm')]")));
    ...
    void testLoginWithInvalidCredentials() {
        ...
        assertEquals("The username and password could not be verified.", errorTitle.getText(), "Error title should be displayed for failed login.");
    ...
    void testOpenNewAccount() {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h1[contains(text(),'Open New Account')]")));
        ...
        WebElement successTitle = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h1[contains(text(),'Account Opened')]")));
    ...
    void testTransferFunds() {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h1[contains(text(),'Transfer Funds')]")));
        ...
        WebElement resultTitle = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h1[contains(text(),'Transfer Complete')]")));
    ...
    void testFindTransactionsByDate() {
        ...
        WebElement resultsTitle = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h1[contains(text(),'Transaction Results')]")));
    ...
    void testForumExternalLink() {
        ...
        if (allWindows.size() > 1) {
            ...
            assertTrue(wait.until(ExpectedConditions.urlContains("parasoft.com")), "URL should contain parasoft.com");
            ...
            // If no new window opened, check if it's a navigation within the same window
            assertTrue(driver.getCurrentUrl().contains("parasoft.com/forum"), "Should navigate to forum page");
        }
    }
}