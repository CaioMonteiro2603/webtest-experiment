...
public class TAT {
    ...
    public void testHomePageLoadsCorrectly() {
        ...
        assertEquals("Central de Atendimento ao Cliente TAT", currentPageTitle, "Page title should be 'Central de Atendimento ao Cliente TAT'");
    ...
    public void testValidFormSubmission() {
        ...
        WebElement phoneField = driver.findElement(By.cssSelector("input[type='number']"));
