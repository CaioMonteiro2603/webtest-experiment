...
public class parabank {
    ...
    public void testValidLogin() {
        ...
        assertTrue(currentUrl.contains("parabank/overview"), "Login should redirect to overview page");
    }
    ...
    public void testNavigationToAccountsOverview() {
        ...
        String currentUrl = driver.getCurrentUrl();
        assertTrue(currentUrl.contains("parabank/overview"), "Should navigate to accounts overview page");
    }
    ...
    public void testMenuNavigation() {
        ...
        assertTrue(currentPageUrl.contains("parabank/overview"), "Should be at Accounts Overview page");
        ...
        assertTrue(updateProfileUrl.contains("parabank/updateprofile"), "Should navigate to Update Profile page");
    }
