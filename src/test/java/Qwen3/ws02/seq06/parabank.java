...
public class parabank {
    ...
    public void testValidLogin() {
        ...
        assertTrue(currentUrl.contains("overview.htm"), "Expected to be on welcome page after login");

        WebElement welcomeMessage = driver.findElement(By.tagName("h1"));
        assertTrue(welcomeMessage.getText().contains("Accounts Overview"), "Welcome message should be displayed");
    }
    ...
    public void testMenuNavigation() {
        ...
        logoutLink.click();
        assertEquals("https://parabank.parasoft.com/parabank/index.htm?ConnType=JDBC", driver.getCurrentUrl(), "Should be back on login page after logout");
    ...
    public void testExternalLinksInFooter() {
        ...
        // Twitter link
        WebElement twitterLink = driver.findElement(By.cssSelector("a[href*='www.twitter.com']"));
        ...
        // Facebook link
        WebElement facebookLink = driver.findElement(By.cssSelector("a[href*='www.facebook.com']"));
        ...
        // LinkedIn link
        WebElement linkedinLink = driver.findElement(By.cssSelector("a[href*='www.linkedin.com']"));
        originalTab = driver.getWindowHandle();
        linkedinLink.click();
        tabs = driver.getWindowHandles();
        for (String tab : tabs) {
    ...
    public void testAccountCreationAndInfo() {
        ...
        assertTrue(driver.getCurrentUrl().contains("register.htm"), "Registration should be completed successfully");
    }
}