...
public class JSFiddle{
    ...
    public void testNavigationToExamplesPage() {
        driver.get(BASE_URL);
        By examplesLink = By.xpath("//a[@href='/demos/' or contains(@href, 'examples') or text()='Examples']");
    ...
    public void testNavigationToDocumentationPage() {
        driver.get(BASE_URL);
        By documentationLink = By.xpath("//a[@href='/docs/' or contains(@href, 'doc') or contains(text(),'Documentation')]");
    ...
    public void testNavigationToSupportPage() {
        driver.get(BASE_URL);
        By supportLink = By.xpath("//a[@href='/support/' or contains(@href, 'support') or contains(text(),'Support')]");
    ...
    public void testNavigationToBlogPage() {
        driver.get(BASE_URL);
        By blogLink = By.xpath("//a[@href='https://blog.jsfiddle.net' or contains(@href, 'blog') or text()='Blog']");
    ...
    public void testNavigationToPricingPage() {
        driver.get(BASE_URL);
        By pricingLink = By.xpath("//a[@href='/pricing/' or contains(@href, 'pricing') or text()='Pricing']");
    ...
    public void testNavigationToAboutPage() {
        driver.get(BASE_URL);
        By aboutLink = By.xpath("//a[@href='/about/' or contains(@href, 'about') or text()='About']");
    ...
    public void testNavigationToPrivacyPolicyPage() {
        driver.get(BASE_URL);
        By privacyLink = By.xpath("//a[@href='/privacy/' or contains(@href, 'privacy') or contains(text(),'Privacy')]");
    ...
    public void testNavigationToTermsOfServicePage() {
        driver.get(BASE_URL);
        By termsLink = By.xpath("//a[@href='/terms/' or contains(@href, 'terms') or contains(text(),'Terms')]");
    ...
    public void testNavigationToStatusPage() {
        driver.get(BASE_URL);
        By statusLink = By.xpath("//a[@href='https://status.jsfiddle.net' or contains(@href, 'status') or text()='Status']");
    ...
    public void testNavigationToTwitterLink() {
        driver.get(BASE_URL);
        By twitterLink = By.xpath("//a[contains(@href,'twitter.com') or contains(@href,'twitter')]");
    ...
    public void testNavigationToGitHubLink() {
        driver.get(BASE_URL);
        By githubLink = By.xpath("//a[contains(@href,'github.com') or contains(@href,'github')]");
    ...
    public void testNavigationToStackOverflowLink() {
        driver.get(BASE_URL);
        By stackOverflowLink = By.xpath("//a[contains(@href,'stackoverflow.com') or contains(@href,'stackoverflow')]");
    ...
    public void testNavigationToLinkedInLink() {
        driver.get(BASE_URL);
        By linkedInLink = By.xpath("//a[contains(@href,'linkedin.com') or contains(@href,'linkedin')]");
    ...
    public void testNavigationToYouTubeLink() {
        driver.get(BASE_URL);
        By youtubeLink = By.xpath("//a[contains(@href,'youtube.com') or contains(@href,'youtube')]");
    ...
    public void testNavigationToRSSFeedLink() {
        driver.get(BASE_URL);
        By rssLink = By.xpath("//a[contains(@href,'feed') or contains(@href,'rss')]");
        ...
        assertTrue(driver.getCurrentUrl().contains("feedburner.com") || driver.getCurrentUrl().contains("feed"), "New tab should be FeedBurner domain");
        driver.close();
        driver.switchTo().window(originalWindow);
    }
    ...
    public void testTryItNowButtonNavigation() {
        driver.get(BASE_URL);
        By tryItNowButton = By.xpath("//a[contains(@class,'btn') and (contains(@href,'/') or contains(text(),'Try'))]");
        WebElement tryItNow = wait.until(ExpectedConditions.elementToBeClickable(tryItNowButton));
        tryItNow.click();

        wait.until(webDriver -> webDriver.getCurrentUrl().contains("/") && !webDriver.getCurrentUrl().equals(BASE_URL));
    ...
    public void testLoginButtonOpensLoginForm() {
        driver.get(BASE_URL);
        By loginButton = By.xpath("//a[contains(@href,'login') or contains(text(),'Login') or contains(text(),'Sign in')]");
    ...
    public void testSignUpButtonNavigation() {
        driver.get(BASE_URL);
        By signUpButton = By.xpath("//a[contains(@href,'signup') or contains(@href,'register') or contains(text(),'Sign')]");
    ...
    public void testSearchFunctionality() {
        driver.get(BASE_URL);
        By searchInput = By.xpath("//input[@name='q' or @type='search' or @placeholder]");
    ...
    public void testNavigationToJavaScriptGuide() {
        driver.get(BASE_URL);
        By jsGuideLink = By.xpath("//a[contains(@href,'javascript') or contains(text(),'JavaScript')]");
    ...
    public void testNavigationToHTMLGuide() {
        driver.get(BASE_URL);
        By htmlGuideLink = By.xpath("//a[contains(@href,'html') or contains(text(),'HTML')]");
    ...
    public void testNavigationToCSSGuide() {
        driver.get(BASE_URL);
        By cssGuideLink = By.xpath("//a[contains(@href,'css') or contains(text(),'CSS')]");
    ...
    public void testNavigationToAPIReference() {
        driver.get(BASE_URL);
        By apiLink = By.xpath("//a[contains(@href,'api') or contains(text(),'API')]");
    ...
    public void testNavigationToEmbeddingGuide() {
        driver.get(BASE_URL);
        By embeddingLink = By.xpath("//a[contains(@href,'embed') or contains(text(),'Embedd')]");
    ...
    public void testNavigationToKeyboardShortcuts() {
        driver.get(BASE_URL);
        By shortcutsLink = By.xpath("//a[contains(@href,'shortcut') or contains(text(),'Shortcut') or contains(text(),'Keyboard')]");
    ...
    public void testNavigationToChangelog() {
        driver.get(BASE_URL);
        By changelogLink = By.xpath("//a[contains(@href,'changelog') or contains(text(),'Changelog') or contains(text(),'Changes')]");
