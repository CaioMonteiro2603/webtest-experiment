...
public class parabank {
    ...
    public void testValidLogin() {
        ...
        WebElement welcomeMessage = wait.until(visibilityOfElementLocated(By.id("leftPanel")));
        Assertions.assertTrue(welcomeMessage.getText().contains("Welcome"), "Welcome message should be displayed after login");
    ...
    public void testInvalidLogin() {
        ...
        WebElement errorMessage = wait.until(visibilityOfElementLocated(By.cssSelector(".error")));
        Assertions.assertTrue(errorMessage.getText().contains("Please check your username and password"),
