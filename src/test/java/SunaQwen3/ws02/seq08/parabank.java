...
public class parabank {
    ...
    void testAboutLinkExternal() {
        ...
        assertTrue(driver.getCurrentUrl().contains("overview.htm"), "Should return to original page after closing external tab");
    }
    ...
    void testRegisterLinkNavigation() {
        ...
        assertEquals("ParaBank | Register for Free Online Account Opening", driver.getTitle());
    }
