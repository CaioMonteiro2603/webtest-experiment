...
public class JPetStoreTest {
    ...
    void testValidLogin() {
        ...
        assertEquals(BASE_URL + "actions/Account.action?viewLoginForm", driver.getCurrentUrl());
    ...
    void testInvalidLoginCredentials() {
        driver.get(BASE_URL + "actions/Account.action?viewLoginForm");
    ...
    void testBrowseCategoriesAndProducts() {
        ...
        assertTrue(driver.getCurrentUrl().contains("viewCategory"), "Should navigate to category view");
    ...
    void testAddToCartAndCheckout() {
        ...
        assertTrue(cartUrl.contains("EditCart"), "Should be on cart edit page");
        ...
        assertTrue(driver.getCurrentUrl().contains("newOrderForm"), "Should be on order form");
    ...
    void testMenuNavigationAndResetAppState() {
        ...
        assertTrue(driver.getCurrentUrl().contains("Catalog.action"), "Should remain on catalog after reset");
    }
    ...
    void testExternalFooterLinks() {
        ...
        assertTrue(driver.findElements(twitterLink).size() > 0, "Twitter link should be present");
        assertTrue(driver.findElements(facebookLink).size() > 0, "Facebook link should be present");
        assertTrue(driver.findElements(linkedinLink).size() > 0, "LinkedIn link should be present");
    ...
    void testLogoutFunctionality() {
        ...
        wait.until(ExpectedConditions.urlContains("Welcome.action"));
        assertTrue(driver.getCurrentUrl().contains("Welcome.action"), "Should return to welcome page after logout");
        assertTrue(driver.getPageSource().contains("Welcome"), "Welcome page should be displayed");
    }
}