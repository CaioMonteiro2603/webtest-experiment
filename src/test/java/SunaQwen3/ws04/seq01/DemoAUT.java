...
public class FormPageTest {
    ...
    public void testPageTitleAndHeader() {
        ...
        Assertions.assertEquals(expectedTitle, driver.getTitle(), "Page title should be 'Form'");
    ...
    public void testFirstNameField() {
        driver.get(BASE_URL);
        WebElement firstNameField = wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("first-name")));
    ...
    public void testLastNameField() {
        driver.get(BASE_URL);
        WebElement lastNameField = wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("last-name")));
        lastNameField.clear();
    ...
    public void testJobTitleField() {
        driver.get(BASE_URL);
        WebElement jobTitleField = wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("job")));
        jobTitleField.clear();
    ...
    public void testEducationLevelRadioButtons() {
        driver.get(BASE_URL);
        WebElement educationRadio = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@value='" + EDUCATION_LEVEL + "']")));
    ...
    public void testSexRadioButtons() {
        driver.get(BASE_URL);
        WebElement sexRadio = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@value='" + SEX + "']")));
        sexRadio.click();
    ...
    public void testSubmitButtonSuccess() {
        ...
        driver.findElement(By.name("job")).sendKeys(JOB_TITLE);

        WebElement educationRadio = driver.findElement(By.xpath("//input[@value='" + EDUCATION_LEVEL + "']"));
        ...
        WebElement sexRadio = driver.findElement(By.xpath("//input[@value='" + SEX + "']"));
        wait.until(ExpectedConditions.elementToBeClickable(sexRadio)).click();

        WebElement experienceCheckbox = driver.findElement(By.id("exp-1"));
