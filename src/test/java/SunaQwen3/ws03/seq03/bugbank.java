...
public class bugbank {
    ...
    void testLogoutFunctionality() {
        ...
        assertTrue(driver.getPageSource().contains("Entrar"), "Login button should be visible on login page");
    }
    ...
    void testAccountCreationFormValidation() {
        ...
        // Click register link
        WebElement registerLink = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Não tem uma conta? Cadastre-se")));
        registerLink.click();

        // Wait for registration form
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("email_cadastro")));
    ...
    void testSuccessfulAccountCreation() {
        ...
        WebElement emailInput = wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("email_cadastro")));
        emailInput.sendKeys(newEmail);

        WebElement passwordInput = driver.findElement(By.name("password_cadastro"));
