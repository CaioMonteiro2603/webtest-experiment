...
public class conduit {
    ...
    public void testHomePageLoads() {
        ...
        Assertions.assertEquals("conduit", driver.getTitle());
    ...
    public void testLoginFunctionality() {
        ...
        WebElement userProfile = wait.until(ExpectedConditions.elementToBeClickable(
            By.cssSelector("a.nav-link[href*='@" + USERNAME + "']")));
    ...
    public void testArticleNavigation() {
        ...
        if (!articles.isEmpty()) {
            ...
            WebElement articleTitleOnPage = driver.findElement(By.cssSelector("div.article-page h1"));
