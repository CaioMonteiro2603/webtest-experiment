...
public class AutomationInTestingTestSuite {
    ...
    public void testHomePageLoads() {
        ...
        WebElement header = wait.until(ExpectedConditions.visibilityOfElementLocated(
            By.cssSelector("h1")));
        Assertions.assertTrue(header.getText().contains("Restful-booker-platform demo"));
    }
    ...
    public void testRoomInformationPage() {
        ...
        List<WebElement> roomCards = driver.findElements(By.cssSelector(".room"));
    ...
    public void testValidAdminLogin() {
        ...
        Assertions.assertTrue(driver.getCurrentUrl().contains("/admin/rooms"));
    }
