...
public class AutomationInTestingTest {
    ...
    public void testHomePage() {
        ...
        WebElement header = wait.until(ExpectedConditions.visibilityOfElementLocated(
            By.cssSelector("h1")));
        Assertions.assertTrue(header.getText().contains("Restful-booker-platform"));
    ...
    public void testRoomsPage() {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(
            By.cssSelector(".room-container")));
        
        // Verify room cards are displayed
        List<WebElement> rooms = driver.findElements(By.cssSelector(".room-container"));
        Assertions.assertTrue(rooms.size() > 0, "No rooms found on rooms page");
        
        // Verify room details
        WebElement firstRoom = rooms.get(0);
        Assertions.assertTrue(firstRoom.findElement(By.cssSelector(".room-title")).isDisplayed());
        Assertions.assertTrue(firstRoom.findElement(By.cssSelector(".room-description")).isDisplayed());
    }
    ...
    public void testBrandingPage() {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(
            By.cssSelector(".branding-container")));
        
        // Verify branding elements
        WebElement title = driver.findElement(By.cssSelector(".branding-title"));
        Assertions.assertTrue(title.isDisplayed());
        
        WebElement description = driver.findElement(By.cssSelector(".branding-description"));
