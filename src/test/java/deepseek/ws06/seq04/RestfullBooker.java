...
public class AutomationInTestingTest {
    ...
    public void testRoomDeletion() {
        ...
        WebElement deleteButton = wait.until(ExpectedConditions.elementToBeClickable(
            By.xpath("//div[@id='room101']//button[contains(text(),'Delete')]")));
        deleteButton.click();

        // Verify room deleted
        wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("room101")));
        List<WebElement> rooms = driver.findElements(By.id("room101"));
