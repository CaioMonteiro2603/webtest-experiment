...
public class TAT {
    ...
    public void testFormSubmission() {
        ...
        WebElement successMessage = wait.until(ExpectedConditions.presenceOfElementLocated(By.id("success-msg")));
    ...
    public void testResetButton() {
        driver.get(BASE_URL);
        WebElement firstNameField = wait.until(ExpectedConditions.presenceOfElementLocated(By.id("first-name")));
        WebElement resetButton = driver.findElement(By.id("btn-clear"));
