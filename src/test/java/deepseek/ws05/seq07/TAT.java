...
public class ContactFormTest {
    ...
    public void testFileUpload() {
        ...
        Assertions.assertTrue(uploadInfo.getText().contains("testfile.txt"), "File should be uploaded successfully");
    }
    ...
    public void testExternalLinks() {
        ...
        WebElement tatLink = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("TAT")));
        tatLink.click();
