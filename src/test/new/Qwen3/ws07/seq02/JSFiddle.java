...
public class JSFiddle {
    ...
    public void testEditorAreas() {
        ...
        WebElement htmlEditor = wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("[data-panel-id='html']")));
        assertTrue(htmlEditor.isDisplayed());
        
        WebElement cssEditor = driver.findElement(By.cssSelector("[data-panel-id='css']"));
        assertTrue(cssEditor.isDisplayed());
        
        WebElement jsEditor = driver.findElement(By.cssSelector("[data-panel-id='javascript']"));
    ...
    public void testCodeEditing() {
        ...
        WebElement htmlEditor = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("[data-panel-id='html'] .CodeMirror textarea")));
        htmlEditor.clear();
        htmlEditor.sendKeys("<h1>Test Heading</h1>");
        
        // Clear and fill CSS editor
        WebElement cssEditor = driver.findElement(By.cssSelector("[data-panel-id='css'] .CodeMirror textarea"));
        cssEditor.clear();
        cssEditor.sendKeys("h1 { color: red; }");
        
        // Clear and fill JS editor
        WebElement jsEditor = driver.findElement(By.cssSelector("[data-panel-id='javascript'] .CodeMirror textarea"));
        jsEditor.clear();
    ...
    public void testPresets() {
        ...
        WebElement presetSelect = driver.findElement(By.cssSelector("[data-panel-id='html'] select"));
        presetSelect.click();
        
        // Get preset options
        List<WebElement> presetOptions = driver.findElements(By.cssSelector("[data-panel-id='html'] select option"));
    ...
    public void testSaveFeature() {
        ...
        WebElement newButton = driver.findElement(By.cssSelector(".new-button"));
        newButton.click();
    ...
    public void testSharingFeatures() {
        ...
        WebElement shareButton = driver.findElement(By.cssSelector(".share-button"));
        assertTrue(shareButton.isDisplayed());
        
        // Verify embed button exists
        WebElement embedButton = driver.findElement(By.cssSelector(".embed-button"));
        assertTrue(embedButton.isDisplayed());
        
        // Verify permalink button exists
        WebElement permalinkButton = driver.findElement(By.cssSelector(".permalink-button"));
    ...
    public void testResponsivePreview() {
        ...
        WebElement responsiveButton = driver.findElement(By.cssSelector(".responsive-button"));
    ...
    public void testSyntaxHighlighting() {
        ...
        assertTrue(jsEditor.getAttribute("value").contains("var x = 5;"));
    }
    ...
    public void testNavigationAndMenus() {
        ...
        WebElement homeLink = driver.findElement(By.cssSelector("a[href*='jsfiddle.net']"));
        assertTrue(homeLink.isDisplayed());
        
        // Test account-related menus (if available)
        try {
            WebElement accountMenu = driver.findElement(By.cssSelector(".account-menu"));
