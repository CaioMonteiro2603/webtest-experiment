...
public class RestfullBooker {
    ...
    public void testPageLoadAndTitle() {
        ...
        assertTrue(pageTitle.contains("RESTful Booker"), "Page title should contain RESTful Booker");
        
        WebElement header = driver.findElement(By.cssSelector("header h1"));
        assertTrue(header.isDisplayed(), "Header should be displayed");
        assertEquals("Shady Meadows B&B", header.getText(), "Header text should match expected value");
    }
    ...
    public void testContactForm() {
        ...
        // Find contact form
        WebElement contactForm = driver.findElement(By.cssSelector(".contact"));
        assertTrue(contactForm.isDisplayed(), "Contact form should be displayed");
        
        // Check form fields
        List<WebElement> formFields = driver.findElements(By.cssSelector(".contact input, .contact textarea"));
        assertTrue(formFields.size() > 0, "Should have form fields");
        
        // Check for contact information
        List<WebElement> contactInfo = driver.findElements(By.cssSelector(".contact p"));
    ...
    public void testServicesSection() {
        ...
        WebElement servicesSection = driver.findElement(By.cssSelector(".row"));
        assertTrue(servicesSection.isDisplayed(), "Services section should be displayed");
        
        // Check services cards
        List<WebElement> serviceCards = driver.findElements(By.cssSelector(".row"));
    ...
    public void testTestimonialsSection() {
        ...
        WebElement testimonialsSection = driver.findElement(By.cssSelector(".row"));
        assertTrue(testimonialsSection.isDisplayed(), "Testimonials section should be displayed");
        
        // Check testimonials
        List<WebElement> testimonialCards = driver.findElements(By.cssSelector(".row"));
    ...
    public void testAboutSection() {
        ...
        // Find about section
        WebElement aboutSection = driver.findElement(By.cssSelector(".col-md-12"));
        assertTrue(aboutSection.isDisplayed(), "About section should be displayed");
        
        // Check about content
        List<WebElement> aboutContent = driver.findElements(By.cssSelector(".col-md-12 p"));
        assertTrue(aboutContent.size() > 0, "About content should be displayed");
    }
        ...
        for (WebElement link : footerLinks) {
            ...
            if (href != null && !href.isEmpty() && !href.startsWith("#")) {
                ...
                try {
                    ...
                    // Some links might not open in new windows, continue
                    continue;
                }
            }
        }
    ...
    public void testContactFormSubmission() {
        ...
        String currentUrl = driver.getCurrentUrl();
        assertTrue(currentUrl.contains("automationintesting.online"), "Should remain on site after submission");
    }
        ...
        for (WebElement link : navLinks) {
            ...
            if (href != null && !href.isEmpty() && !href.startsWith("#")) {
                try {
                    ...
                    link.click();
                    Thread.sleep(1000); // Simple wait for navigation
    ...
    public void testSocialMediaLinks() {
        ...
        String mainWindowHandle = driver.getWindowHandle();
        boolean foundSocialMediaLink = false;
        ...
        assertTrue(foundSocialMediaLink, "Should have at least one social media link");
    }
}