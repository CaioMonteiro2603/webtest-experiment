...
public class RestfullBooker {
    ...
    public void testHomePageLoadsCorrectly() {
        ...
        assertTrue(currentPageTitle.length() > 0, "Page title should not be empty");
        
        WebElement mainHeader = driver.findElement(By.tagName("h1"));
        assertTrue(mainHeader.getText().contains("Resting"), "Main header should mention Resting");
    ...
    public void testContactFormSubmission() {
        ...
        WebElement subjectField = driver.findElement(By.id("phone"));
        subjectField.sendKeys("Test Subject");
        
        WebElement messageField = driver.findElement(By.id("subject"));
        messageField.sendKeys("Test Subject");
        
        WebElement descriptionField = driver.findElement(By.id("description"));
        descriptionField.sendKeys("This is a test message for the contact form.");
    ...
    public void testNavigationToBookingPage() {
        ...
        try {
            WebElement bookNowButton = driver.findElement(By.cssSelector("button[onclick*='booking']"));
            bookNowButton.click();
            
            // Wait for page load and check URL
            wait.until(ExpectedConditions.urlContains("reservation"));
            String currentUrl = driver.getCurrentUrl();
            assertTrue(currentUrl.contains("reservation"), "Should navigate to reservation page");
    ...
    public void testContactFormFieldInteractions() {
        ...
        assertEquals("1234567890", phoneField.getAttribute("value"), "Phone field value should match input");
        ...
        descriptionField.sendKeys("This is a sample test message.");
        assertEquals("This is a sample test message.", descriptionField.getAttribute("value"), "Description field text should match input");
    ...
    public void testPageContentVerification() {
        ...
        WebElement mainContent = driver.findElement(By.cssSelector(".container"));
