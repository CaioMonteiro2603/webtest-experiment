...
public class RestfullBooker {
    ...
    public void testHomePageLoad() {
        ...
        assertTrue(title.contains("Shady Meadows B&B"), "Page title should contain 'Shady Meadows B&B'");
    ...
    public void testBookingFunctionality() {
        ...
        WebElement bookingLink = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Book this room")));
        bookingLink.click();
        ...
        assertTrue(currentUrl.contains("room"), "Should navigate to booking page");
    ...
    public void testUserAccountFunctionality() {
        ...
        WebElement accountLink = driver.findElement(By.linkText("Login"));
        accountLink.click();
    ...
    public void testNavigationMenu() {
        ...
        for (WebElement link : navLinks) {
            ...
            if (!linkText.isEmpty() && !linkText.equals("Book this room")) { // Skip book now link
                link.click();
