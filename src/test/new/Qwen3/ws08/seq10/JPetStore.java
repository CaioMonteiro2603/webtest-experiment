...
public class JPetStore {
    ...
    void testHeaderNavigationItems_ArePresent() {
        ...
        WebElement navbar = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#MenuContent")));
    ...
    void testValidLogin_SuccessfulRedirectToAccount() {
        ...
        WebElement loginButton = driver.findElement(By.cssSelector("input[name='signon']"));
    ...
    void testInvalidLogin_ErrorMessageShown() {
        ...
        assertTrue(error.getText().contains("Invalid") || error.getText().contains("invalid"), "Error message should indicate invalid credentials");
    }
    ...
    void testCategoryNavigation_Dogs_DisplayProducts() {
        ...
        WebElement dogsLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='categoryId=DOGS']")));
        dogsLink.click();
    ...
    void testProductDetailPage_LoadsCorrectly() {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#Catalog")));
        assertTrue(isElementPresent(By.cssSelector("img[src*='bulldog']")), "Bulldog image should be displayed");
        assertTrue(driver.findElement(By.cssSelector("h2")).getText().contains("Bulldog"), "Page should display Bulldog as title");
    }
    ...
    void testAddToCart_FromProductPage() {
        ...
        WebElement cartTitle = driver.findElement(By.cssSelector("h2"));
    ...
    void testUpdateCartQuantity_ChangesTotal() {
        ...
        WebElement quantityField = wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("EST-6")));
        quantityField.clear();
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(".total")));
        WebElement subtotal = driver.findElement(By.xpath("//td[contains(text(),'Sub Total:')]/following-sibling::td"));
        String priceText = subtotal.getText();
    ...
    void testMyAccountLink_RequiresLogin() {
        ...
        WebElement loginMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("h3")));
        assertTrue(loginMessage.getText().contains("Please") || loginMessage.getText().contains("Sign In"), "My Account should redirect to login when not authenticated");
    }
