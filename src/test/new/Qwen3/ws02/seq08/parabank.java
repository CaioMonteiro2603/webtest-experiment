...
public class parabank {
    ...
    public void testNavigationMenu() {
        ...
        homeLink.click();
        assertTrue(driver.getCurrentUrl().startsWith("https://parabank.parasoft.com/parabank/index.htm"));
    ...
    public void testAccountServices() {
        driver.get("https://parabank.parasoft.com/parabank/overview.htm");
        WebElement accountsLink = driver.findElement(By.linkText("Open New Account"));
        accountsLink.click();
        assertTrue(driver.getCurrentUrl().contains("/parabank/openaccount.htm"));

        WebElement transfersLink = driver.findElement(By.linkText("Transfer Funds"));
        transfersLink.click();
        assertTrue(driver.getCurrentUrl().contains("/parabank/transfer.htm"));
        
        driver.get("https://parabank.parasoft.com/parabank/overview.htm");
        WebElement billsLink = driver.findElement(By.linkText("Bill Pay"));
        billsLink.click();
        assertTrue(driver.getCurrentUrl().contains("/parabank/billpay.htm"));

        driver.get("https://parabank.parasoft.com/parabank/overview.htm");
        WebElement servicesLink = driver.findElement(By.linkText("Services"));
        servicesLink.click();
        assertTrue(driver.getCurrentUrl().contains("/parabank/services.htm"));
    }
