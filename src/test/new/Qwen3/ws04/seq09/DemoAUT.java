...
public class DemoAUT {
    ...
    void testPageTitleAndHeader() {
        ...
        assertEquals("Demo AUT", driver.getTitle(), "Page title should match");
    ...
    void testGenderSelectionPersistence() {
        ...
        WebElement genderRadioAfterRefresh = driver.findElement(By.id("male"));
    ...
    void testRoleDropdownOptions() {
        ...
        java.util.List<String> expectedOptions = java.util.Arrays.asList("Developer", "QA Lead", "QA Engineer", "Manager", "");
    ...
    void testSubmitButtonDisabledUntilRequiredFilled() {
        ...
        assertTrue(submitButton.isEnabled(), "Submit button should be enabled initially");
