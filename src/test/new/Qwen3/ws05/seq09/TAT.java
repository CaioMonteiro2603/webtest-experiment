...
public class TAT {
    ...
    void testFormFieldsArePresent() {
        ...
        WebElement requestType = driver.findElement(By.id("product"));
    ...
    void testSuccessfulFormSubmission() {
        ...
        Select requestType = new Select(driver.findElement(By.id("product")));
        requestType.selectByVisibleText("Webdesign");
        ...
        assertEquals("Mensagem enviada com sucesso.", successMessage.getText().trim(), "Success message should match expected");
    }
    ...
    void testFirstNameIsRequired() {
        ...
        String firstNameClass = driver.findElement(By.id("firstName")).getAttribute("class");
    ...
    void testLastNameIsRequired() {
        ...
        String lastNameClass = driver.findElement(By.id("lastName")).getAttribute("class");
    ...
    void testMessageIsRequired() {
        ...
        String messageClass = driver.findElement(By.id("open-text-area")).getAttribute("class");
    ...
    void testAgreeCheckboxIsRequired() {
        ...
        WebElement agreeLabel = driver.findElement(By.cssSelector("label[for='checkbox']"));
    ...
    void testRequestTypeDropdownOptions() {
        ...
        Select requestType = new Select(wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("product"))));
        ...
        java.util.List<String> expectedOptions = java.util.Arrays.asList("Select an issue...", "Blog", "Webdesign", "Bug");
    ...
    void testPhoneFieldAcceptsOnlyDigits() {
        ...
        assertEquals("", phoneField.getAttribute("value"), "Phone field should only accept digits");
    }
    ...
    void testRequestTypeSelectionAffectsAppearance() {
        ...
        Select requestType = new Select(wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("product"))));
        requestType.selectByVisibleText("Bug");
    ...
    void testFooterLinksOpenInNewTab() {
        ...
        WebElement githubLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[target='_blank']")));
    ...
    void testFormResetButton() {
        ...
        Select requestType = new Select(driver.findElement(By.id("product")));
        requestType.selectByVisibleText("Blog");
        ...
        assertEquals("", firstName.getAttribute("value"), "First name should be cleared");
