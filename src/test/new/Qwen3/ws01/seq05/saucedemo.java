...
public class saucedemo {
    ...
    public void testSortingDropdown() {
        ...
        List<WebElement> sortOptions = driver.findElements(By.xpath("//select[@class='product_sort_container']/option"));
    ...
    public void testFooterSocialLinks() {
        ...
        List<WebElement> footerLinks = driver.findElements(By.cssSelector("ul.social > li > a"));
