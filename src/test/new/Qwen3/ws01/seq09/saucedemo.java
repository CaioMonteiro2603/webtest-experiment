...
public class saucedemo {
    ...
    void testSortingLowToHigh() {
        ...
        wait.until(ExpectedConditions.attributeContains(sortSelect, "value", "lohi"));
    ...
    void testSortingHighToLow() {
        ...
        wait.until(ExpectedConditions.attributeContains(sortSelect, "value", "hilo"));
    ...
    void testSortingAtoZ() {
        ...
        wait.until(ExpectedConditions.attributeContains(sortSelect, "value", "az"));
    ...
    void testSortingZtoA() {
        ...
        wait.until(ExpectedConditions.attributeContains(sortSelect, "value", "za"));
