...
public class bugbank {
    ...
    void testRegisterNewUser() {
        ...
        WebElement confirmPasswordField = driver.findElement(By.cssSelector("input[placeholder*='Confirme']"));
    ...
    void testNavigationToTransactions() {
        ...
        WebElement transactionsTab = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[contains(text(),'Transfer')]")));
        transactionsTab.click();

        WebElement pageTitle = wait.until(ExpectedConditions.visibilityOfElementLocated(By.tagName("h2")));
        assertTrue(pageTitle.getText().contains("Transferência"), "Should navigate to Transações page");
    }
    ...
    void testSendMoney() {
        ...
        WebElement sendMoneyTab = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[contains(text(),'Transfer')]")));
        sendMoneyTab.click();
    ...
    void testLogout() {
        ...
        WebElement profileButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button[aria-label*='perfil']")));
        profileButton.click();

        WebElement logoutOption = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//li[contains(text(),'Sair')]")));
        logoutOption.click();

        WebElement loginButton = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[contains(text(),'Acessar')]")));
    ...
    private void loginIfNecessary() {
        try {
            driver.get(BASE_URL);
            WebElement loginButton = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//button[contains(text(),'Acessar')]")));
