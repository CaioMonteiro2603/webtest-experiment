...
public class conduit {
    ...
    void testSignInLink_NavigatesToSignInPage() {
        ...
        assertTrue(isElementPresent(By.cssSelector("input[placeholder='Email']")), "Login form should contain email field");
        assertTrue(isElementPresent(By.cssSelector("input[placeholder='Password']")), "Login form should contain password field");
    }
    ...
    void testInvalidLogin_ShowErrorMessages() {
        ...
        assertTrue(error.getText().toLowerCase().contains("email") || error.getText().toLowerCase().contains("password"),
    ...
    void testSignUpLink_NavigatesToRegisterPage() {
        ...
        assertTrue(isElementPresent(By.cssSelector("input[placeholder='Username']")), "Registration form should contain username field");
        assertTrue(isElementPresent(By.cssSelector("input[placeholder='Email']")), "Registration form should contain email field");
        assertTrue(isElementPresent(By.cssSelector("input[placeholder='Password']")), "Registration form should contain password field");
    }
    ...
    void testTagNavigation_FilterArticlesByTag() {
        ...
        assertTrue(!tags.isEmpty(), "At least one tag should be available");
    ...
    void testArticlePreview_ClickOpensArticleDetail() {
        ...
        WebElement firstArticleLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".article-preview h1")));
    ...
    void testUserProfile_ClickNavigatesToProfile() {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".article-meta .author")));
