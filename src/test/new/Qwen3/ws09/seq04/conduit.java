...
public class conduit {
    ...
    public void testHomePageLoad() {
        ...
        assertTrue(title.contains("Conduit") || title.contains("conduit"));
    ...
    public void testNavigationToArticles() {
        ...
        // Navigate to global feed articles
        WebElement globalFeedLink = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Global Feed")));
    ...
    public void testArticleSorting() {
        ...
        // Navigate to global feed articles
        WebElement globalFeedLink = driver.findElement(By.linkText("Global Feed"));
        globalFeedLink.click();
        
        wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(".article-preview")));
        
        // Try to interact with feed tabs if available
        List<WebElement> feedTabs = driver.findElements(By.cssSelector(".feed-toggle a"));
    ...
    public void testRegisterPage() {
        ...
        WebElement registerForm = wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("form")));
    ...
    public void testArticleFeedFunctionality() {
        ...
        if (!articlePreviews.isEmpty()) {
            ...
            List<WebElement> titles = firstArticle.findElements(By.cssSelector("h1, h2, .preview-link"));
            if (!titles.isEmpty()) {
    ...
    public void testHomePageFeatures() {
        ...
        List<WebElement> headings = driver.findElements(By.cssSelector("h1, h2, .banner h1"));
        assertTrue(headings.size() > 0);
        assertTrue(headings.get(0).isDisplayed());
        
        // Verify featured articles section
        List<WebElement> articlesSections = driver.findElements(By.cssSelector("section, .container, .home-page"));
        assertTrue(articlesSections.size() > 0);
        assertTrue(articlesSections.get(0).isDisplayed());
