...
public class BrasilAgritest {
    ...
    public void testUserManagement() {
        ...
        WebElement usersLink = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Usuários")));
        usersLink.click();
    ...
    public void testProductManagement() {
        ...
        WebElement productsLink = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Produtos")));
        productsLink.click();
    ...
    public void testSettingsAccess() {
        ...
        WebElement settingsLink = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Configurações")));
        settingsLink.click();
