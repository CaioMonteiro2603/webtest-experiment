...
public class DemoAUT {
    ...
    void testPageLoadsSuccessfully() {
        ...
        WebElement header = driver.findElement(By.xpath("//h1[text()='Form']"));
        Assertions.assertTrue(header.isDisplayed(), "Main header 'Form' should be visible.");
    ...
    void testMultipleCheckboxes() {
        ...
        driver.findElement(By.xpath("//label[contains(text(),'Contribute to open source')]/input")).click();
        driver.findElement(submitButton).click();
