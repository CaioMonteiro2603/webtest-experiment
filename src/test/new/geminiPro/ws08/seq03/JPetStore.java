...
public class JPetStore {
    ...
    void testLoginWithInvalidCredentials() {
        ...
        WebElement errorMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[contains(text(), 'Invalid username or password')]")));
    ...
    void testFullECommerceFlow() {
        ...
        // --- 6. Verify Success ---
        WebElement successMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[contains(text(), 'Thank you, your order has been submitted')]")));
