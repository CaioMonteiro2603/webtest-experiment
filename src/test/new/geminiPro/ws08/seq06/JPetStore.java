...
public class JPetStore {
    ...
    void cartManagementTest() {
        ...
        WebElement link = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(@href, 'CATS')]")));
        link.click();
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(@href, 'FL-DSH-01')]"))).click();
    ...
    void loginFunctionalityTest() {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//form[@name='signon']")));
        ...
        assertTrue(welcomeMessage.getText().contains("Welcome"), "Welcome message was not found after successful login.");
    ...
    void fullCheckoutFlowTest() {
        ...
        WebElement reptilesLink = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(@href, 'REPTILES')]")));
        reptilesLink.click();
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(@href, 'RP-SN-01')]"))).click();
        wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Add to Cart"))).click();
    ...
    void externalLinkTest() {
        ...
        WebElement mybatisLink = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(@href, 'mybatis.org')]")));
        mybatisLink.click();
