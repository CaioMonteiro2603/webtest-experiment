...
public class TAT {
    ...
    void testSuccessfulFormSubmission() {
        ...
        // Wait for success message instead of URL change
    ...
    void testFullFormInteraction() {
        ...
        // Try different approach for email radio button
        WebElement emailRadio = driver.findElement(By.xpath("//input[@name='preferred-contact' and @value='email']"));
        emailRadio.click();
    ...
    void testPrivacyPolicyPageNavigation() {
        ...
        // Wait for privacy page content instead of URL change
        WebElement privacyHeader = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("title")));
        Assertions.assertEquals("CAC TAT - Política de privacidade", driver.getTitle(), "The privacy page title is incorrect.");
