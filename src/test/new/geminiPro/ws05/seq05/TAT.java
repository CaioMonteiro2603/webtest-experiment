...
public class TAT {
    ...
    void testSuccessfulFormSubmission() {
        ...
        driver.findElement(By.xpath("//input[@name='atendimento-tipo' and @value='Feedback']")).click();
    ...
    void testErrorWhenPhoneIsRequired() {
        ...
        driver.findElement(By.xpath("//input[@name='contact-type' and @value='Telefone']")).click();
