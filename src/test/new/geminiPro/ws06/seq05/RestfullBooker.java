...
public class RestfullBooker {
    ...
    private final By adminUsernameInput = By.cssSelector("input[name='username']");
    private final By adminPasswordInput = By.cssSelector("input[name='password']");
    private final By adminLoginButton = By.cssSelector("button[type='submit']");
