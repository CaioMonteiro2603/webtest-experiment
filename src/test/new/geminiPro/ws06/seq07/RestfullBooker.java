...
public class RestfullBooker {
    ...
    void testRoomBookingEndToEnd() {
        driver.get(BASE_URL);
        wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button.book-room"))).click();
    ...
    void testExternalLinkNavigation() {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("footer a[href*='shady-meadows.com']"))).click();
    ...
    private void performAdminLogin(String username, String password) {
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("input[data-testid='username']"))).sendKeys(username);
        driver.findElement(By.cssSelector("input[data-testid='password']")).sendKeys(password);
