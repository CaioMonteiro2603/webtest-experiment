...
public class RestfullBooker {
    ...
    void testHomePageLoadsAndHeadersCorrect() {
        ...
        WebElement welcomeHeader = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".col-sm-10 h2")));
    ...
    void testContactFormSuccessfulSubmission() {
        ...
        WebElement contactForm = driver.findElement(By.cssSelector("div.contact"));
        ...
        WebElement successMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(
            By.xpath("//div[contains(@class,'contact')]//h2[text()='Thanks for getting in touch Gemini Tester!']")
        ));
    ...
    void testRoomBookingProcess() {
        ...
        WebElement bookButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button[class*='book-room']")));
    ...
    void testAdminLoginAndMessageVerificationAndLogout() {
        ...
        wait.until(ExpectedConditions.urlToBe("https://automationintesting.online/#/admin/messages"));
        WebElement messagesHeader = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h2[text()='Messages']")));
        ...
        By messageLocator = By.xpath("//p[contains(text(), '" + uniqueSubject + "')]");
