...
public class RestfullBooker {
    ...
    void testPageLoadAndInitialState() {
        ...
        WebElement heroImage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("hotel-logo")));
    ...
    void testContactFormSubmissionError() {
        ...
        WebElement contactForm = wait.until(ExpectedConditions.visibilityOfElementLocated(CONTACT_NAME_INPUT));
