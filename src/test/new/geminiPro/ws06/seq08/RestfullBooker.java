...
public class RestfullBooker {
    ...
    void testAdminLoginWithInvalidCredentials() {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#username"))).sendKeys(ADMIN_USER);
    ...
    void testAdminLoginAndLogout() {
        driver.get(ADMIN_URL);
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#username"))).sendKeys(ADMIN_USER);
        driver.findElement(By.cssSelector("#password")).sendKeys(ADMIN_PASS);
        driver.findElement(By.cssSelector("#doLogin")).click();
        ...
        logoutLink.click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#doLogin")));
    ...
    void testGitHubExternalLink() {
        assertExternalLink(By.cssSelector("footer a[href*='github.com']"), "github.com");
    }
}