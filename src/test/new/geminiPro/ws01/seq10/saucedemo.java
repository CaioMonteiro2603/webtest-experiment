...
public class saucedemo {
    ...
    void testResetAppState() {
        ...
        String itemId = "add-to-cart-sauce-labs-bike-light";
    ...
    void testLogout() {
        ...
        Assertions.assertEquals("https://www.saucedemo.com/", driver.getCurrentUrl(), "Logout should return to the login page.");
