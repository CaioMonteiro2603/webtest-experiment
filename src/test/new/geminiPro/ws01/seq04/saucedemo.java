...
public class saucedemo {
    ...
    void testSuccessfulLoginAndInventoryPageLoad() {
        ...
        assertEquals("https://www.saucedemo.com/inventory.html", driver.getCurrentUrl(), "URL should be the inventory page after login.");
    ...
    void testAddAndRemoveItemFromInventory() {
        ...
        addToCartButton = driver.findElement(By.xpath("//div[text()='Sauce Labs Fleece Jacket']/ancestor::div[@class='inventory_item']//button"));
    ...
    void testFooterTwitterLink() {
        ...
        handleExternalLink(By.className("social_twitter"), "twitter.com");
    }
    ...
    void testFooterFacebookLink() {
        ...
        handleExternalLink(By.className("social_facebook"), "facebook.com/saucelabs");
    }
    ...
    void testFooterLinkedInLink() {
        ...
        handleExternalLink(By.className("social_linkedin"), "linkedin.com/company/sauce-labs");
    }
    ...
    private void handleExternalLink(By locator, String expectedUrlPart) {
        ...
        if (locatorStr.contains("sidebar_link")) {
            driver.findElement(By.id("react-burger-menu-btn")).click();
        ...
        assertEquals("https://www.saucedemo.com/inventory.html", driver.getCurrentUrl(), "Should have returned to the inventory page.");
    }
