...
public class JSFiddle {
    ...
    private static final By HTML_EDITOR_CONTAINER = By.cssSelector(".panel-html .CodeMirror");
    ...
    private static final By FOOTER_DOCS_LINK = By.linkText("Documentation");
    ...
    private static final By SIGNUP_FORM = By.id("signup");
    ...
    void testPageLoadAndInitialLayout() {
        ...
        Assertions.assertTrue(driver.findElement(By.cssSelector(".panel-css .CodeMirror")).isDisplayed(), "CSS editor panel is not visible.");
        Assertions.assertTrue(driver.findElement(By.cssSelector(".panel-js .CodeMirror")).isDisplayed(), "JavaScript editor panel is not visible.");
    }
