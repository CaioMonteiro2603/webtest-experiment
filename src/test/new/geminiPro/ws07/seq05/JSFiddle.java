...
public class JSFiddle {
    ...
    private final By htmlEditor = By.cssSelector(".panel-html .CodeMirror");
    private final By cssEditor = By.cssSelector(".panel-css .CodeMirror");
    private final By jsEditor = By.cssSelector(".panel-javascript .CodeMirror");
    ...
    void testExternalFooterLinks(String selector, String expectedDomain) {
        ...
        WebElement link = wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(selector)));
