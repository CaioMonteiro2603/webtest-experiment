...
public class BrasilAgritest {
    ...
    void testSidebarNavigation() {
        login();
        navigateToFarms();
        assertEquals("https://brasilagri.com/farms", driver.getCurrentUrl(), "URL should be for the Farms page.");
        ...
        assertEquals("https://brasilagri.com/crops", driver.getCurrentUrl(), "URL should be for the Crops page.");
        logout();
    }
