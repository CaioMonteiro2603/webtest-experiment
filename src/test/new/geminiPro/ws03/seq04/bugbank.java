...
public class bugbank {
    ...
    private void handleExternalLink(By locator, String expectedDomain) {
        ...
        WebElement linkElement = wait.until(ExpectedConditions.elementToBeClickable(locator));
        
        // Get href attribute to verify it's not empty
        String href = linkElement.getAttribute("href");
        if (href == null || href.isEmpty() || href.equals("about:blank")) {
            Assertions.fail("Link href is empty or about:blank");
        }
        
        // Open link in new tab using JavaScript click to avoid click intercepting issues
        ((org.openqa.selenium.JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", linkElement);
        ((org.openqa.selenium.JavascriptExecutor) driver).executeScript("arguments[0].click();", linkElement);
    ...
    void testFooterSocialMediaLinks() {
        ...
        handleExternalLink(By.linkText("Facebook"), "facebook.com");
        handleExternalLink(By.linkText("LinkedIn"), "linkedin.com");
    }
}