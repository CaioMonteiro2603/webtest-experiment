...
public class bugbank {
    ...
    void testUserRegistration() {
        ...
        By regEmailInput = By.xpath("//input[@name='email']");
        By regNameInput = By.xpath("//input[@name='name']");
        By regPasswordInput = By.xpath("//input[@name='password']");
        By regPassConfirmInput = By.xpath("//input[@name='passwordConfirmation']");
