...
public class bugbank {
    ...
    private static final By REGISTER_PASSWORD_INPUT = By.xpath("//input[@name='password']");
    ...
    private static final By TRANSFER_LINK = By.xpath("//button[text()='Transferência']");
    private static final By STATEMENT_LINK = By.xpath("//button[text()='Extrato']");
