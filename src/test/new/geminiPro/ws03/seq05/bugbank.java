...
public class bugbank {
    ...
    void testUserRegistration() {
        ...
        driver.findElement(passwordInput).sendKeys(testPassword);
        driver.findElement(By.xpath("//div[label[text()='Senha']]/following-sibling::div//input")).sendKeys(testPassword); // Password confirmation
    ...
    void testInvalidLogin() {
        ...
        WebElement modal = wait.until(ExpectedConditions.visibilityOfElementLocated(modalText));
        Assertions.assertTrue(modal.getText().matches("Usuário ou senha inválido\\.?|Usuário ou senha inválida\\.?"), "Error message for wrong password is not correct.");
        ...
        Assertions.assertTrue(modal.getText().matches("Usuário ou senha inválido\\.?|Usuário ou senha inválida\\.?"), "Error message for non-existent user is not correct.");
        driver.findElement(closeModalButton).click();
    }
