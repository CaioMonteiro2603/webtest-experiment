...
public class conduit {
    ...
    void userRegistrationTest() {
        ...
        WebElement userProfileLink = wait.until(ExpectedConditions.visibilityOfElementLocated(
            By.xpath("//a[contains(@href, '#/@') and contains(., '" + testUsername + "')]")));
    ...
    void loginAndLogoutTest() {
        ...
        WebElement logoutButton = wait.until(ExpectedConditions.elementToBeClickable(
            By.xpath("//button[contains(., 'Click here to logout')]")));
    ...
    void deleteArticleTest() {
        ...
        WebElement deleteButton = wait.until(ExpectedConditions.elementToBeClickable(
            By.xpath("//button[contains(., 'Delete Article')]")));
        JavascriptExecutor js = (JavascriptExecutor) driver;
        ...
        WebElement noArticlesMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(
            By.xpath("//div[contains(., 'No articles are here... yet.')]")));
    ...
    void externalLinkTest() {
        ...
        JavascriptExecutor js = (JavascriptExecutor) driver;
        js.executeScript("arguments[0].scrollIntoView(true);", thinksterLink);
        try {
            Thread.sleep(500);
        } catch (InterruptedException e) {
            Thread.currentThread().interrupt();
        }
        js.executeScript("arguments[0].click();", thinksterLink);
