...
public class conduit {
    ...
    void testUserRegistration() {
        ...
        // Wait for the settings page or any profile indicator
        wait.until(ExpectedConditions.urlContains("#/"));
        Assertions.assertTrue(driver.getCurrentUrl().contains("#/"), "Registration did not complete successfully.");
    }
    ...
    void testLoginWithInvalidCredentials() {
        ...
        // Wait for error message or URL change indicating failed login
        wait.until(ExpectedConditions.urlContains("#/login"));
        Assertions.assertTrue(driver.getCurrentUrl().contains("#/login"), "Login should have failed and stayed on login page.");
    }
    ...
    void testSuccessfulLoginAndLogout() {
        ...
        // Check that we're on the home page after successful login
        wait.until(ExpectedConditions.urlContains("#/"));
        Assertions.assertTrue(driver.getCurrentUrl().contains("#/"), "Should be redirected to home page after successful login.");
    ...
    void testExternalGitHubLink() {
        ...
        Assertions.assertTrue(driver.getCurrentUrl().contains("github.com"), "The GitHub link did not navigate to a GitHub repository.");
