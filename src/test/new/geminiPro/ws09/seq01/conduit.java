...
public class conduit{
    ...
    void testUserRegistration() {
        ...
        WebElement userLink = wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("a[href='#/@" + USERNAME + "']")));
        Assertions.assertTrue(userLink.isDisplayed(), "Registration failed or user was not logged in.");
    }
    ...
    void testInvalidLogin() {
        ...
        try {
            ...
            // If logout button not found, we might already be logged out
            driver.get(BASE_URL);
        }
