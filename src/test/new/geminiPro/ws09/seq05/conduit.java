...
public class conduit {
    ...
    void testUserRegistration() {
        ...
        WebElement userProfileLink = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[contains(@href, '#/profile')]")));
    ...
    void testSuccessfulLoginAndLogout() {
        ...
        Assertions.assertTrue(
            driver.findElement(By.xpath("//a[contains(@href, '#/profile')]")).isDisplayed(),
