...
public class conduit {
    ...
    void testUserRegistration() {
        ...
        By userProfileLink = By.cssSelector("a[href='#/profile/" + testUsername + "']");
    ...
    void testLoginAndLogout() {
        ...
        WebElement profileLink = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("a[href='#/profile/" + testUsername + "']")));
        ...
        performLogin(testEmail, testPassword);
        profileLink = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("a[href='#/profile/" + testUsername + "']")));
    ...
    void testCreateEditDeleteArticle() {
        performLogin(testEmail, testPassword);
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("a[href='#/profile/" + testUsername + "']")));
    ...
    void testFilterArticlesByTag() {
        // Wait for tags to be present on the page
        wait.until(ExpectedConditions.numberOfElementsToBeMoreThan(By.cssSelector("div.sidebar div.tag-list a"), 0));
        List<WebElement> tags = driver.findElements(By.cssSelector("div.sidebar div.tag-list a"));
