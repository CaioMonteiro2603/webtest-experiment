...
public class JSFiddle {
    ...
    public void testNavigationToExamplesPage() {
        driver.get(BASE_URL);
        scrollToBottom();
        By examplesLink = By.cssSelector("a[href='https://jsfiddle.net/examples/']");
    ...
    public void testNavigationToApiPage() {
        driver.get(BASE_URL);
        scrollToBottom();
        By apiLink = By.cssSelector("a[href='https://jsfiddle.net/api/']");
    ...
    public void testNavigationToHelpPage() {
        driver.get(BASE_URL);
        scrollToBottom();
        By helpLink = By.cssSelector("a[href='https://jsfiddle.net/help/']");
    ...
    public void testFooterFacebookLink() {
        driver.get(BASE_URL);
        scrollToBottom();
        By facebookLink = By.cssSelector("a[href='https://www.facebook.com/jsfiddle']");
    ...
    public void testNavigationToPricingPage() {
        driver.get(BASE_URL);
        scrollToBottom();
        By pricingLink = By.cssSelector("a[href='https://jsfiddle.net/pricing/']");
    ...
    public void testNavigationToTeamPage() {
        driver.get(BASE_URL);
        scrollToBottom();
        By teamLink = By.cssSelector("a[href='https://jsfiddle.net/team/']");
    ...
    public void testNavigationToPrivacyPage() {
        driver.get(BASE_URL);
        scrollToBottom();
        By privacyLink = By.cssSelector("a[href='https://jsfiddle.net/privacy/']");
    ...
    public void testNavigationToTermsPage() {
        driver.get(BASE_URL);
        scrollToBottom();
        By termsLink = By.cssSelector("a[href='https://jsfiddle.net/terms/']");
    ...
    public void testNavigationToContactPage() {
        driver.get(BASE_URL);
        scrollToBottom();
        By contactLink = By.cssSelector("a[href='https://jsfiddle.net/contact/']");
    ...
    public void testNavigationToEmbedPage() {
        driver.get(BASE_URL);
        scrollToBottom();
        By embedLink = By.cssSelector("a[href='https://jsfiddle.net/embed/']");
    ...
    public void testNavigationToKeyboardShortcutsPage() {
        driver.get(BASE_URL);
        scrollToBottom();
        By shortcutsLink = By.cssSelector("a[href='https://jsfiddle.net/shortcuts/']");
    ...
    public void testNavigationToChangelogPage() {
        driver.get(BASE_URL);
        scrollToBottom();
        By changelogLink = By.cssSelector("a[href='https://jsfiddle.net/changelog/']");
    ...
    public void testNavigationToSecurityPage() {
        driver.get(BASE_URL);
        scrollToBottom();
        By securityLink = By.cssSelector("a[href='https://jsfiddle.net/security/']");
    ...
    public void testNavigationToAccessibilityPage() {
        driver.get(BASE_URL);
        scrollToBottom();
        By accessibilityLink = By.cssSelector("a[href='https://jsfiddle.net/accessibility/']");
    ...
    public void testNavigationToCookiesPage() {
        driver.get(BASE_URL);
        scrollToBottom();
        By cookiesLink = By.cssSelector("a[href='https://jsfiddle.net/cookies/']");
