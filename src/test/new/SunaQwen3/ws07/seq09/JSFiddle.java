...
public class JSFiddle {
    ...
    public void testEditorElementsArePresent() {
        ...
        // Wait for result iframe instead of result div
        By resultFrame = By.cssSelector("iframe[name='result']");
        wait.until(ExpectedConditions.presenceOfElementLocated(resultFrame));
        WebElement resultElement = driver.findElement(resultFrame);
        assertNotNull(resultElement, "Result frame should be present");

        // Check for HTML, CSS, JS panels using more specific selectors
        By htmlPanel = By.cssSelector(".panel.html");
        By cssPanel = By.cssSelector(".panel.css");
        By jsPanel = By.cssSelector(".panel.javascript");
    ...
    public void testRunButtonFunctionality() {
        ...
        By runButton = By.cssSelector("button[title='Run']");
        ...
        By resultIframe = By.cssSelector("iframe[name='result']");
    ...
    public void testSaveFiddleButtonRequiresLogin() {
        ...
        By loginModal = By.cssSelector(".modal-login");
    ...
    public void testNavigationToAboutPage() {
        ...
        assertTrue(driver.getCurrentUrl().contains("about"), "About page URL should contain about");
    ...
    public void testFooterSocialLinks_OpenInNewTab() {
        ...
        // Find all footer social links using broader selectors
        By footerLinks = By.cssSelector("a[href*='twitter.com'], a[href*='facebook.com'], a[href*='linkedin.com']");
    ...
    public void testSearchBoxFunctionality() {
        ...
        // Wait for results
        By searchResults = By.cssSelector(".fiddle-list");
        wait.until(ExpectedConditions.presenceOfElementLocated(searchResults));

        List<WebElement> fiddles = driver.findElements(By.cssSelector(".fiddle-item"));
    ...
    public void testFrameworkSelectionDropdown() {
        ...
        By frameworkDropdown = By.cssSelector("select[name='framework']");
        wait.until(ExpectedConditions.visibilityOfElementLocated(frameworkDropdown));
    ...
    public void testLoginModalAppearsOnPrivateFiddle() {
        ...
        By privateFiddleButton = By.cssSelector("button[title*='private']");
    ...
    public void testNavigationToResourcesPage() {
        ...
        By resourcesLink = By.cssSelector("a[href*='resources']");
        ...
        // Assert URL contains resources
        assertTrue(driver.getCurrentUrl().contains("resources"), "Resources page URL should contain resources");
