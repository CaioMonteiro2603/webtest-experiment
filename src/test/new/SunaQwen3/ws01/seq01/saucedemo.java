...
public class saucedemo {
    ...
    public void testFooterTwitterLink() {
        ...
        boolean isTwitter = driver.getCurrentUrl().contains("twitter.com") || driver.getCurrentUrl().contains("x.com");
        Assertions.assertTrue(isTwitter, "Twitter footer link should open Twitter");
        driver.close();
        driver.switchTo().window(originalWindow);
    }
    ...
    public void testFooterFacebookLink() {
        ...
        String originalWindow = driver.getWindowHandle();
        ((JavascriptExecutor) driver).executeScript("arguments[0].setAttribute('target','_blank');", facebookLink);
        facebookLink.click();
        ...
        try {
            ...
            // If new window doesn't open, verify link href
            String href = facebookLink.getAttribute("href");
            Assertions.assertTrue(href != null && href.contains("facebook.com"), "Facebook link href should contain facebook.com");
        }
    }
    ...
    public void testFooterLinkedInLink() {
        ...
        String originalWindow = driver.getWindowHandle();
        ((JavascriptExecutor) driver).executeScript("arguments[0].setAttribute('target','_blank');", linkedinLink);
        linkedinLink.click();
        ...
        try {
            ...
            Assertions.assertTrue(href != null && href.contains("linkedin.com"), "LinkedIn link href should contain linkedin.com");
        }
    }
