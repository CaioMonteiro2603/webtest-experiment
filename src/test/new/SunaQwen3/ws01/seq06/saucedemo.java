...
public class saucedemo {
    ...
    void testSortingOptions() {
        ...
        wait.until(ExpectedConditions.attributeContains(sortDropdown, "value", "az"));
        ...
        wait.until(ExpectedConditions.attributeContains(sortDropdown, "value", "za"));
        ...
        wait.until(ExpectedConditions.attributeContains(sortDropdown, "value", "lohi"));
        ...
        wait.until(ExpectedConditions.attributeContains(sortDropdown, "value", "hilo"));
    ...
    void testFooterExternalLinks() {
        ...
        // Test Twitter link
        testExternalLink(By.cssSelector("a[href*='twitter.com']"), "x.com");
