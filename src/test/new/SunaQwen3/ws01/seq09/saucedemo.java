...
public class saucedemo {
    ...
    public void testSortingDropdownOptions() {
        ...
        assertTrue(lastItemText.compareTo(firstItemText) <= 0, "Items should be sorted Z to A");
    ...
    public void testMenuAllItemsNavigation() {
        ...
        // Open menu
        WebElement menuButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("#menu_button")));
        menuButton.click();
    ...
    public void testMenuResetAppState() {
        ...
        // Close menu
        menuButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("#menu_button")));
        menuButton.click();
