...
public class saucedemo {
    ...
    void testMenuAboutExternalLink() {
        ...
        assertTrue(driver.getCurrentUrl().contains("saucedabs.com"), "About link should redirect to saucelabs.com domain");
        driver.close();
    ...
    private void navigateToInventory() {
        if (!driver.getCurrentUrl().contains("inventory.html")) {
            ...
            if (isElementPresent(By.cssSelector(".bm-menu-wrap"))) {
                try {
                    if (driver.findElement(By.cssSelector(".bm-menu-wrap")).getAttribute("class").contains("menu-open")) {
                        closeMenu();
                    }
                } catch (Exception e) {
                }
