...
public class parabank {
    ...
    void testValidLogin() {
        ...
        assertTrue(driver.getCurrentUrl().contains("overview"), "Should be redirected to overview page after login");
    ...
    void testAccessAdminPageViaFooter() {
        ...
        adminLink.click();
        wait.until(ExpectedConditions.titleIs("ParaBank | Administration"));
