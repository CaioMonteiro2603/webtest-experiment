...
public class parabank {
    ...
    public void testAccessFindOwnerPage() {
        ...
        try {
            ...
            // If "Find Owner" link doesn't exist, skip this test
            System.out.println("Find Owner link not found, skipping test");
        }
    }
    ...
    public void testExternalFooterLinks() {
        ...
        try {
            ...
            System.out.println("Facebook link not found, skipping");
        }
        ...
        try {
            ...
            System.out.println("LinkedIn link not found, skipping");
        }
    }
    ...
    public void testOpenNewAccount() {
        ...
        try {
            ...
            List<WebElement> messages = driver.findElements(By.cssSelector(".error, .success"));
            if (!messages.isEmpty()) {
                String messageText = messages.get(0).getText();
                assertTrue(messageText.contains("Congratulations") || messageText.contains("open"), "Account opening message should be present");
            }
        }
    }
    ...
    public void testRequestLoan() {
        ...
        try {
            ...
            List<WebElement> results = driver.findElements(By.cssSelector(".error, .success"));
            if (!results.isEmpty()) {
                String resultText = results.get(0).getText();
                assertTrue(resultText.length() > 0, "Loan result should be displayed");
            }
        }
    }
    ...
    public void testUpdateProfile() {
        ...
        try {
            ...
            // Check for any update confirmation
            List<WebElement> messages = driver.findElements(By.cssSelector(".error, .success"));
            if (!messages.isEmpty()) {
                String messageText = messages.get(0).getText();
                assertTrue(messageText.contains("Updated") || messageText.contains("Profile"), "Profile update confirmation should be displayed");
            }
        }
    }
}