...
public class conduit {
    ...
    void testNavigationToSettings() {
        ...
        WebElement userMenu = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".nav-item .nav-link[href*='@" + USERNAME.split("@")[0] + "']")));
        userMenu.click();
    ...
    void testCreateNewArticle() {
        ...
        WebElement newPostLink = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("New Article")));
        newPostLink.click();
    ...
    void testVisitProfilePage() {
        ...
        WebElement profileLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".nav-item .nav-link[href*='@" + USERNAME.split("@")[0] + "']")));
        profileLink.click();
    ...
    void testFooterTwitterLink() {
        driver.get(BASE_URL);
        WebElement twitterLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='https://twitter.com']")));
    ...
    void testFooterFacebookLink() {
        driver.get(BASE_URL);
        WebElement facebookLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='https://www.facebook.com']")));
        String originalWindow = driver.getWindowHandle();
        facebookLink.click();
    ...
    void testFooterLinkedInLink() {
        driver.get(BASE_URL);
        WebElement linkedinLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='https://www.linkedin.com']")));
        String originalWindow = driver.getWindowHandle();
        linkedinLink.click();
