...
public class conduit {
    ...
    void testInvalidLogin() {
        ...
        By error = By.cssSelector(".error-messages");
    ...
    void testNavigationMenu() {
        ...
        By profile = By.xpath("//a[contains(@href, '/@')]");
    ...
    void testFooterExternalLinks() {
        ...
        By twitterLink = By.cssSelector("a[href*='twitter']");
        By facebookLink = By.cssSelector("a[href*='facebook']");
        By linkedinLink = By.cssSelector("a[href*='linkedin']");
    ...
    void testArticleInteraction() {
        ...
        By favoriteCount = By.cssSelector(".btn-primary .counter");
