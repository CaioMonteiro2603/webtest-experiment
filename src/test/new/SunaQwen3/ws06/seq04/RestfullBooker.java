...
public class RestfullBooker {
    ...
    public void testInvalidLoginCredentials() {
        ...
        assertTrue(errorMessage.getText().contains("Username and password do not match") || 
                   errorMessage.getText().contains("Epic sadface: Username and password do not match"), 
    ...
    public void testMenuBurgerButtonAbout() {
        ...
        assertTrue(driver.getCurrentUrl().contains("saucelabs"), "About link should open Saucelabs page");
        driver.close();
