...
public class RestfullBooker {
    ...
    private static final String INVENTORY_PAGE_URL = BASE_URL + "inventory.html";
    ...
    public void testLoginPageLoadsSuccessfully() {
        ...
        Assertions.assertTrue(currentUrl.contains("saucedemo"), "URL should contain 'saucedemo' after navigating to login page");
    ...
    public void testInvalidLoginShowsErrorMessage() {
        ...
        WebElement errorElement = wait.until(visibilityOfElementLocated(By.cssSelector("[data-test='error']")));
    ...
    public void testMenuBurgerButtonFunctionality() {
        ...
        // Close menu
        WebElement closeMenuButton = wait.until(elementToBeClickable(By.id("react-burger-cross-btn")));
    ...
    public void testMenuLogoutRedirectsToLoginPage() {
        ...
        wait.until(urlContains("saucedemo"));
        String currentUrl = driver.getCurrentUrl();
        Assertions.assertTrue(currentUrl.contains("saucedemo"), "After logout, URL should contain 'saucedemo'");
    }
    ...
    public void testMenuResetAppStateClearsCart() {
        ...
        WebElement addToCartButton = wait.until(elementToBeClickable(By.cssSelector(".btn_inventory")));
    ...
    public void testFooterTwitterLinkOpensInNewTab() {
        ...
        String originalWindow = driver.getWindowHandle();
        WebElement twitterLink = wait.until(elementToBeClickable(By.cssSelector("a[href*='twitter']")));
        twitterLink.click();
        ...
        Assertions.assertTrue(twitterUrl.contains("twitter"), "Twitter link should open a page containing 'twitter'");
    ...
    public void testFooterFacebookLinkOpensInNewTab() {
        ...
        WebElement facebookLink = wait.until(elementToBeClickable(By.cssSelector("a[href*='facebook']")));
        facebookLink.click();
        ...
        Assertions.assertTrue(facebookUrl.contains("facebook"), "Facebook link should open a page containing 'facebook'");
    ...
    public void testFooterLinkedInLinkOpensInNewTab() {
        ...
        WebElement linkedinLink = wait.until(elementToBeClickable(By.cssSelector("a[href*='linkedin']")));
        linkedinLink.click();
        ...
        Assertions.assertTrue(linkedinUrl.contains("linkedin"), "LinkedIn link should open a page containing 'linkedin'");
