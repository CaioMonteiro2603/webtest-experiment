...
public class RestfullBooker {
    ...
    void testMenuAllItems() {
        ...
        WebElement menuButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".menu-button, button[aria-label='Menu'], #menuButton")));
        menuButton.click();
    ...
    void testFooterTwitterLink() {
        ...
        WebElement twitterLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='twitter'], .social-link-twitter, footer a[href*='twitter']")));
        twitterLink.click();
    ...
    void testFooterFacebookLink() {
        ...
        WebElement facebookLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='facebook'], .social-link-facebook, footer a[href*='facebook']")));
        facebookLink.click();
    ...
    void testFooterLinkedInLink() {
        ...
        WebElement linkedinLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='linkedin'], .social-link-linkedin, footer a[href*='linkedin']")));
        linkedinLink.click();
