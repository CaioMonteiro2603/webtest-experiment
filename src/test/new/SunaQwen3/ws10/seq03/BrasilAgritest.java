...
public class BrasilAgritest {
    ...
    public void testValidLogin() {
        ...
        assertTrue(driver.getCurrentUrl().startsWith("https://gestao.brasilagritest.com"), "Should be redirected to main page after login");
    ...
    public void testMenuNavigation() {
        ...
        // Open menu
        WebElement menuButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button.navbar-toggler, .menu-toggle")));
        menuButton.click();
        ...
        allItemsLink.click();
        wait.until(ExpectedConditions.urlContains("gestao.brasilagritest.com"));
        assertTrue(driver.getCurrentUrl().contains("gestao.brasilagritest.com"), "Should navigate to items page");

        // Open menu again
        menuButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button.navbar-toggler, .menu-toggle")));
        menuButton.click();
