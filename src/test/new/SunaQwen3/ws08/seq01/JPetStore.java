...
public class JPetStore {
    ...
    void testNavigationToFishCategory() {
        ...
        WebElement fishLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("img[src*='fish']")));
        fishLink.click();
        
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("img[src*='anglerfish']")));
    ...
    void testAddItemToCart() {
        ...
        WebElement updateCartButton = driver.findElement(By.cssSelector("input[value='Update Cart']"));
    ...
    void testProceedToCheckout() {
        ...
        WebElement checkoutButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("input[value='Proceed to Checkout']")));
    ...
    void testBrowseDogsCategory() {
        ...
        WebElement dogsLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("img[src*='dogs']")));
        dogsLink.click();

        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("img[src*='bulldog']")));
    ...
    void testLogoutFunctionality() {
        ...
        WebElement signOutLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='signoff']")));
        signOutLink.click();
    ...
    void testSearchFunctionality() {
        ...
        WebElement searchField = wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("searchForm")));
        WebElement keywordInput = driver.findElement(By.name("keyword"));
        keywordInput.sendKeys("Bulldog");
        keywordInput.submit();
