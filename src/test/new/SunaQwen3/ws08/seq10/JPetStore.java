...
public class JPetStore {
    ...
    void testBrowseCategoriesAndProducts() {
        ...
        List<WebElement> categoryLinks = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.cssSelector("#Content a[href*='Category']")));
        ...
        for (WebElement link : categoryLinks) {
            ...
            if (!itemLinks.isEmpty()) {
                ...
                wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.cssSelector("#Content a[href*='Category']")));
            }
    ...
    void testAddToCartAndCheckout() {
        ...
        WebElement fishLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='Category'][href*='FISH']")));
        fishLink.click();
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='addItemToCart']")));
        WebElement addToCart = driver.findElement(By.cssSelector("a[href*='addItemToCart']"));
        addToCart.click();
    ...
    void testMenuNavigation() {
        ...
        WebElement menuButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='Menu']")));
        menuButton.click();
        ...
        menuButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='Menu']")));
        menuButton.click();
    ...
    void testFooterSocialLinks() {
        ...
        assertTrue(socialLinks.isEmpty(), "Footer should contain social links");
