...
public class JPetStore {
    ...
    public void testValidLogin() {
        ...
        WebElement loginButton = driver.findElement(By.name("save"));
    ...
    public void testBrowseCategoriesAndProducts() {
        ...
        wait.until(visibilityOfElementLocated(By.className("products")));

        List<WebElement> productLinks = driver.findElements(By.cssSelector(".products a"));
    ...
    public void testAddToCartAndCheckout() {
        ...
        driver.findElements(By.cssSelector(".products a")).get(0).click();
        wait.until(visibilityOfElementLocated(By.tagName("h3")));

        // Add to cart
        WebElement addToCartLink = wait.until(elementToBeClickable(By.linkText("Add to Cart")));
        addToCartLink.click();
        ...
        // Continue as guest
        WebElement continueButton = wait.until(elementToBeClickable(By.name("newOrder")));
        ...
        WebElement continueToShipping = driver.findElement(By.name("newOrder"));
        ...
        for (WebElement link : footerLinks) {
            ...
            if (href.contains("twitter.com") || href.contains("facebook.com") || href.contains("linkedin.com")) {
                ...
                try {
                    ...
                    // If new window doesn't open, continue with other links
                    continue;
                }
            }
        }
        if (foundExternalLink) {
            Assertions.assertTrue(true, "External links processed");
        }
    }
    ...
    public void testSearchFunctionality() {
        ...
        List<WebElement> results = driver.findElements(By.xpath("//*[contains(text(),'Goldfish') or contains(text(),'goldfish')]"));
    ...
    public void testLogout() {
        // First login to ensure we can logout
        driver.get(BASE_URL);
        WebElement signInLink = wait.until(elementToBeClickable(By.linkText("Sign In")));
        signInLink.click();
        ...
        wait.until(visibilityOfElementLocated(By.xpath("//h3[text()[contains(.,'Welcome')]]")));

        // Now logout
        WebElement logoutLink = wait.until(elementToBeClickable(By.linkText("Sign Out")));
        logoutLink.click();

        WebElement signInLinkAfterLogout = wait.until(elementToBeClickable(By.linkText("Sign In")));
