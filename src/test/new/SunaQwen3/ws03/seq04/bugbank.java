...
public class bugbank {
    ...
    void testValidLogin() {
        driver.get(BASE_URL);
        assertEquals("BugBank | O banco com bugs e falhas do seu jeito", driver.getTitle(), "Page title should be 'BugBank | O banco com bugs e falhas do seu jeito'");
        ...
        WebElement loginButton = driver.findElement(By.xpath("//button[contains(., 'Acessar')]"));
        loginButton.click();
        ...
        WebElement logoutButton = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[contains(., 'Sair')]")));
    ...
    void testLogoutFunctionality() {
        ...
        WebElement logoutButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[contains(., 'Sair')]")));
        logoutButton.click();
        ...
        WebElement loginButton = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[contains(., 'Acessar')]")));
    ...
    private void loginIfNotOnHomePage() {
        if (!driver.getCurrentUrl().contains("home")) {
            ...
            List<WebElement> logoutButtons = driver.findElements(By.xpath("//button[contains(., 'Sair')]"));
            ...
            // Wait for home page
            wait.until(ExpectedConditions.urlContains("home"));
            wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//button[contains(., 'Sair')]")));
        }
    }
}