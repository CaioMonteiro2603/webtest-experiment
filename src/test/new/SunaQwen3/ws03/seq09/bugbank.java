...
public class bugbank {
    ...
    void testValidLogin() {
        ...
        WebElement loginButton = driver.findElement(By.xpath("//button[text()='Entrar']"));
        loginButton.click();
    ...
    void testLogoutFunctionality() {
        ...
        assertTrue(driver.findElement(By.xpath("//button[text()='Entrar']")).isDisplayed(), "Login button should be visible");
    }
