...
public class DemoAUT {
    ...
    public void testPageLoadsSuccessfully() {
        ...
        assertTrue(title.contains("aut") || title.contains("Form") || title.contains("Demo"), "Page title should contain 'aut' or 'Form' or 'Demo'");
    ...
    public void testFormFieldsArePresent() {
        ...
        By genderMaleRadio = By.xpath("//input[@type='radio' and @value='Male']");
        By genderFemaleRadio = By.xpath("//input[@type='radio' and @value='Female']");
    ...
    public void testFormSubmissionWithValidData() {
        ...
        assertTrue(message.contains("Thanks for submitting") || message.contains("success") || message.contains("Thanks"), "Success message should be displayed");
    }
    ...
    private void fillForm(String firstName, String lastName, String gender, String dob, 
        ...
        By firstNameField = By.name("firstName");
        By lastNameField = By.name("lastName");
        By genderRadio = By.xpath("//input[@type='radio' and @value='" + gender + "']");
        By dobField = By.name("bday");
        By addressField = By.name("address");
        By emailField = By.name("email");
        By passwordField = By.name("password");
        ...
        // Select gender
        WebElement genderInput = wait.until(ExpectedConditions.elementToBeClickable(genderRadio));
