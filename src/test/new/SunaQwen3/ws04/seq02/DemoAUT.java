...
public class DemoAUT {
    ...
    public void testPageLoadsSuccessfully() {
        ...
        Assertions.assertTrue(title.contains("aut"), "Page title should contain 'aut'");
    ...
    public void testExternalLinksInFooter() {
        ...
        // No footer links found, skipping this test
        Assertions.assertTrue(true, "No external links in footer found");
    }
