...
public class TAT {
    ...
    void testValidLogin() {
        driver.get(BASE_URL);
        assertTrue(driver.getTitle().contains("Swag Labs") || driver.getTitle().contains("Swag") || driver.getTitle().contains("Sauce"), "Page title should contain 'Swag Labs' or related text");
