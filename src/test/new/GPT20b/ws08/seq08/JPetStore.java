...
public class JPetStore {
    ...
    public void testFooterSocialLinks() {
        driver.get(BASE_URL);
        By twitter = By.cssSelector("a[href*='twitter.com'], a[href*='twitter']");
        By facebook = By.cssSelector("a[href*='facebook.com'], a[href*='facebook']");
        By linkedin = By.cssSelector("a[href*='linkedin.com'], a[href*='linkedin']");
        List<WebElement> links = getElements(twitter);
        links.addAll(getElements(facebook));
        links.addAll(getElements(linkedin));
        Assertions.assertTrue(!links.isEmpty(), "No social links found in footer");
        String original = driver.getWindowHandle();
