...
public class conduit {
    ...
    public void testBurgerMenuNavigation() {
        ...
        List<WebElement> burgerElements = driver.findElements(By.cssSelector(".navbar-toggler, button.navbar-toggler"));
        if (burgerElements.isEmpty()) {
            // Burger menu not present; test passes
            return;
        }
        WebElement burger = wait.until(ExpectedConditions.elementToBeClickable(
                burgerElements.get(0)));
        burger.click();
