...
public class conduit {
    ...
    public void testHomePageLoads() {
        ...
        assertTrue(driver.getTitle().toLowerCase().contains("conduit") || driver.getTitle().toLowerCase().contains("realworld"),
                "Page title should contain 'Realworld' or 'Conduit'");
    ...
    private void clickLoginModal() {
        WebElement loginBtn = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href='#login'], .nav-link[href*='login']")));
        loginBtn.click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("div.modal-body, form")));
    }
    ...
    private void logoutIfPresent() {
        ...
        if (!logoutLinks.isEmpty()) {
            ...
            wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href='#login'], .nav-link[href*='login']")));
        }
    }
