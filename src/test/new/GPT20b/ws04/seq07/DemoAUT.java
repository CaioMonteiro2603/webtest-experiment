...
public class DemoAUT {
    ...
    public void testPageLoads() {
        ...
        Assertions.assertTrue(title != null && !title.isEmpty(), "Page should load with a valid title");
    }
    ...
    public void testFormFieldsExist() {
        ...
        WebElement nameField = findElementWithFallback(
                List.of(By.id("firstName"), By.name("firstName"), By.cssSelector("input[placeholder='First Name']")));
