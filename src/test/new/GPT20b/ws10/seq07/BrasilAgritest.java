...
public class BrasilAgritest {
    ...
    private void login() {
        ...
        wait.until(ExpectedConditions.urlToBe("https://gestao.brasilagritest.com/"));
        Assertions.assertEquals("https://gestao.brasilagritest.com/", driver.getCurrentUrl(),
                "After login, should be redirected to main page");
    }
    ...
    public void testSortingDropdown() {
        login();
        driver.get(BASE_URL.replace("/login", "/items"));
    ...
    public void testBurgerMenuInteractions() {
        ...
        wait.until(ExpectedConditions.urlToBe("https://gestao.brasilagritest.com/"));
        Assertions.assertEquals("https://gestao.brasilagritest.com/", driver.getCurrentUrl(),
                "After reset, should land on main page");
    ...
    public void testCheckoutFlow() {
        ...
        driver.get(BASE_URL.replace("/login", "/cart"));
