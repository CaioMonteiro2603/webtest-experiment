...
public class BrasilAgritest {
    ...
    public void testLoginPageLoads() {
        ...
        assertTrue(title.toLowerCase().contains("login") || title.toLowerCase().contains("entrar"), "Title should reference login");
    ...
    public void testInvalidLoginShowsError() {
        ...
        assertTrue(!errorMsgs.isEmpty() || driver.getCurrentUrl().contains("/login"), "Error message should appear on invalid login or remain on login page");
    ...
    public void testValidLoginAndLogout() {
        ...
        wait.until(ExpectedConditions.urlContains("/gestao"));
