...
public class BrasilAgritest {
    ...
    private void login() {
        ...
        wait.until(ExpectedConditions.or(
            ...
            ExpectedConditions.presenceOfElementLocated(By.xpath("//a[contains(text(),'Logout')]"))
        ));
        Assertions.assertTrue(
                elementExists(By.cssSelector("a[href*='logout']")) || elementExists(By.xpath("//a[contains(text(),'Logout')]")),
                "Logout link should be present after successful login");
    }

    private void loginIfNeeded() {
        if (!elementExists(By.cssSelector("a[href*='logout']")) && !elementExists(By.xpath("//a[contains(text(),'Logout')]"))) {
            login();
        }
    }
    ...
    public void testHomePageLoads() {
        navigateTo("");
        Assertions.assertTrue(
                driver.getTitle().toLowerCase().contains("brasil") || driver.getTitle().toLowerCase().contains("gestao"),
                "Home page title should contain 'brasil' or 'gestao'");
    }
