...
public class BrasilAgritest {
    ...
    public void testLoginPageElementsPresent() {
        ...
        findElement("button#login", "button[type='submit']", "button[name='login']", "button.login");
    }
    ...
    public void testInvalidLoginShowsError() {
        ...
        assertTrue(!errors.isEmpty(), "An error message should appear for invalid credentials");
    }
    ...
    public void testValidLoginAndLogout() {
        ...
        assertTrue(!dashboardElems.isEmpty(), "Dashboard element should be visible after login");
    ...
    public void testBurgerMenuOptions() {
        ...
        WebElement burger = wait.until(ExpectedConditions.elementToBeClickable(
                By.cssSelector(".navbar-toggler, button#menu-toggle, button.burger-menu, button[data-target*='menu'], button[aria-controls*='menu']")));
        burger.click();
