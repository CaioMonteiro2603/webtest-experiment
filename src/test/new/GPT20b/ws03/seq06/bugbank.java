...
public class bugbank {
    ...
    private void login(String email, String password) {
        ...
        WebElement loginBtn = driver.findElement(
                By.xpath("//button[contains(text(),'Entrar') or @id='login-submit' or @type='submit']"));
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//header//p[contains(text(),'bem vindo')]")));
    }
    ...
    public void testValidLogin() {
        ...
        Assertions.assertTrue(driver.getCurrentUrl().contains("/home"),
                "After login, URL should contain home");
        Assertions.assertTrue(driver.findElements(
                By.xpath("//header//p[contains(text(),'bem vindo')]")).size() > 0,
    ...
    public void testInvalidLogin() {
        ...
        try {
            WebElement error = wait.until(ExpectedConditions.visibilityOfElementLocated(
                    By.cssSelector(".kLtcCZ, .hDzCFH, .jXhZfk")));
            Assertions.assertTrue(error.getText().toLowerCase().contains("usuário ou senha inválidos"),
                    "Error message should indicate invalid credentials");
        } catch (Exception e) {
            // Alternative error selector
            WebElement modal = wait.until(ExpectedConditions.visibilityOfElementLocated(
                    By.xpath("//div[contains(@class,'modal')]//p")));
            Assertions.assertTrue(modal.getText().toLowerCase().contains("usuário ou senha inválidos"),
                    "Error message should indicate invalid credentials");
        }
    }
    ...
    public void testMenuActions() {
        ...
        resetAppState();
        Assertions.assertTrue(driver.getCurrentUrl().contains("/home"),
                "After reset, should land on main home page");
    }
