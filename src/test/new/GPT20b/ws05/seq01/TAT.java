...
public void testPageLoadsCorrectly() {
    navigateToBase();
    Assertions.assertTrue(driver.getTitle().toLowerCase().contains("central de atendimento ao cliente - tat"),
            "Page title should contain 'central de atendimento ao cliente - tat'");
}
