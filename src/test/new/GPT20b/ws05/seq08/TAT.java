...
public class TAT {
    ...
    public void testPageLoadAndTitle() {
        ...
        Assertions.assertTrue(title.contains("CAC"),
    ...
    public void testExternalLinksPolicy() {
        driver.get(BASE_URL);
        List<WebElement> links = driver.findElements(By.xpath("//a[@href and (starts-with(@href,'http://') or starts-with(@href,'https://'))]"));
        ...
        Assertions.assertTrue(foundExternal, "No external links found on the page.");
    }
