...
public class RestfullBooker{
    ...
    private void loginIfNeeded() {
        if (!elementExists(By.id("inventory-list"))) {
            navigateToHome();
            WebElement userEl = wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("username")));
            WebElement passEl = wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("password")));
            WebElement loginBtn = wait.until(ExpectedConditions.elementToBeClickable(By.id("doLogin")));
    ...
    public void testPageLoadsCorrectly() {
        navigateToHome();
        Assertions.assertTrue(driver.getTitle().toLowerCase().contains("restful-booker"),
                "Page title should contain 'Restful-Booker'");
    }
