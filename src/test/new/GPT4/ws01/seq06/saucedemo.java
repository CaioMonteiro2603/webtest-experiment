...
public class saucedemo {
    ...
    public void testSortDropdown() {
        ...
        for (int i = 0; i < options.size(); i++) {
            optionValues[i] = options.get(i).getAttribute("value");
        }
        
        for (String value : optionValues) {
            dropdown = wait.until(ExpectedConditions.elementToBeClickable(By.className("product_sort_container")));
            dropdown.click();
            WebElement option = dropdown.findElement(By.cssSelector("option[value='" + value + "']"));
            option.click();
    ...
    public void testFooterLinks() {
        ...
        for (WebElement link : socialLinks) {
            ...
            if (href.contains("twitter.com") || href.contains("x.com")) expectedDomain = "x.com";
            if (href.contains("facebook.com")) expectedDomain = "facebook.com";
            if (href.contains("linkedin.com")) expectedDomain = "linkedin.com";
