...
public class saucedemo {
    ...
    public void testSortDropdown() {
        ...
        for (int i = 0; i < options.size(); i++) {
            ...
            WebElement selectedOption = sortDropdown.getFirstSelectedOption();
            wait.until(ExpectedConditions.textToBePresentInElement(selectedOption, selectedOption.getText()));
            Assertions.assertEquals(selectedOption.getText(), sortDropdown.getFirstSelectedOption().getText(),
    ...
    public void testMenuLogout() {
        ...
        Assertions.assertTrue(driver.getCurrentUrl().contains("/v1/index.html"), "Logout should redirect to login page");
    }
    ...
    public void testFooterTwitterLink() {
        performLogin();
        WebElement twitter = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("li.social_twitter > a")));
        twitter.click();
    ...
    public void testFooterFacebookLink() {
        performLogin();
        WebElement facebook = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("li.social_facebook > a")));
        facebook.click();
    ...
    public void testFooterLinkedInLink() {
        performLogin();
        WebElement linkedin = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("li.social_linkedin > a")));
        linkedin.click();
