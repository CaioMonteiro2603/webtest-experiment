...
public class saucedemo {
    ...
    public void testFooterSocialLinks() {
        ...
        WebElement twitterLink = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//ul[@class='social']//li[@class='social_twitter']/a")));
        twitterLink.click();
        ...
        Assertions.assertTrue(twitterUrl.contains("twitter.com"), "Expected Twitter link to open correct external site.");
        driver.close();
        driver.switchTo().window(originalWindow);

        WebElement facebookLink = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//ul[@class='social']//li[@class='social_facebook']/a")));
        facebookLink.click();
        ...
        Assertions.assertTrue(facebookUrl.contains("facebook.com"), "Expected Facebook link to open correct external site.");
        driver.close();
        driver.switchTo().window(originalWindow);

        WebElement linkedinLink = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//ul[@class='social']//li[@class='social_linkedin']/a")));
        linkedinLink.click();
        ...
        Assertions.assertTrue(linkedinUrl.contains("linkedin.com"), "Expected LinkedIn link to open correct external site.");
        driver.close();
        driver.switchTo().window(originalWindow);
