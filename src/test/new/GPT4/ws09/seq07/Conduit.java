...
public class Conduit {
    ...
    public void testGlobalFeedIsVisible() {
        driver.get(BASE_URL);
        WebElement globalFeed = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(text(),'Global Feed')]")));
        globalFeed.click();
    ...
    public void testArticleNavigation() {
        driver.get(BASE_URL);
        WebElement articleLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".article-preview")));
        articleLink.click();
    ...
    public void testFooterTwitterLink() {
        ...
        Assertions.assertTrue(driver.getCurrentUrl().contains("twitter"), "External Twitter page should open");
    ...
    public void testFooterFacebookLink() {
        ...
        Assertions.assertTrue(driver.getCurrentUrl().contains("facebook"), "External Facebook page should open");
    ...
    public void testFooterLinkedInLink() {
        driver.get(BASE_URL);
        String originalWindow = driver.getWindowHandle();
        WebElement liLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='linkedin']")));
        liLink.click();
        ...
        Assertions.assertTrue(driver.getCurrentUrl().contains("linkedin"), "External LinkedIn page should open");
    ...
    public void testLogout() {
        ...
        try {
            WebElement userLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='@demo']")));
            userLink.click();
            ...
            Assertions.fail("Logout failed: " + e.getMessage());
        }
    }
}