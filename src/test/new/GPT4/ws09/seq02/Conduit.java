...
public class Conduit {
    ...
    public void testFooterTwitterLink() {
        driver.get(BASE_URL);
        WebElement footerLink = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(@href,'https://twitter.com')]")));
    ...
    public void testGlobalFeedPresence() {
        driver.get(BASE_URL);
        WebElement globalFeed = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[contains(text(),'Global Feed')]")));
