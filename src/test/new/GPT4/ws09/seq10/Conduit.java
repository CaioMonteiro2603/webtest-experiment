...
public class Conduit {
    ...
    public void testHomePageLoads() {
        openBasePage();
        Assertions.assertTrue(driver.getTitle().toLowerCase().contains("conduit") || driver.getTitle().toLowerCase().contains("conduit"), "Page title should contain 'conduit'");
    ...
    public void testNavigateToSignInPage() {
        openBasePage();
        WebElement signInLink = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(@href, '#login') or contains(., 'Sign in')]")));
        signInLink.click();
    ...
    public void testNavigateToSignUpPage() {
        openBasePage();
        WebElement signUpLink = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(@href, '#register') or contains(., 'Sign up')]")));
        signUpLink.click();
        wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("h1.text-xs-center")));
    ...
    public void testTagNavigation() {
        openBasePage();
        WebElement tag = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[contains(@class, 'tag-list')]//a[contains(@class, 'tag-pill')]")));
