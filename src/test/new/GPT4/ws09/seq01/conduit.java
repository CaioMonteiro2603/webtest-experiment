...
public class conduit {
    ...
    public void testClickTagFromSidebar() {
        ...
        WebElement tag = wait15.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".sidebar .tag-list a")));
        String tagText = tag.getText();
        tag.click();
        WebElement activeTag = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[contains(@class,'nav-link') and contains(@class,'active') and text()='" + tagText + "']")));
