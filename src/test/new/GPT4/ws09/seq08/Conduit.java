...
public class Conduit {
    ...
    public void testGlobalFeedLoads() {
        driver.get(BASE_URL);
        WebElement globalFeedTab = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@class='nav-link' and contains(text(),'Global Feed')]")));
        globalFeedTab.click();
    ...
    public void testFooterTextPresence() {
        ...
        Assertions.assertTrue(footerText.contains("realworld") || footerText.toLowerCase().contains("conduit"), "Footer should contain 'realworld' or 'conduit'");
    }
