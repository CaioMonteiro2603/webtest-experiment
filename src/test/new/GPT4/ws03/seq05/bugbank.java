...
public class bugbank {
    ...
    public void testRegisterAndReturnToLogin() {
        driver.get(BASE_URL);
        WebElement registerBtn = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href='/register']")));
        registerBtn.click();
        ...
        WebElement backToLogin = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href='/']")));
        backToLogin.click();
