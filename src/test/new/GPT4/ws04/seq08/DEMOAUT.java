...
public class DEMOAUT {
    ...
    public void testFormPageLoadsSuccessfully() {
        driver.get(BASE_URL);
        WebElement header = wait.until(ExpectedConditions.presenceOfElementLocated(By.tagName("h2")));
    ...
    public void testFormSubmissionValidData() {
        ...
        longWait.until(ExpectedConditions.elementToBeClickable(By.name("first_name"))).sendKeys("John");
    ...
    public void testFormSubmissionMissingFields() {
        ...
        WebDriverWait longWait = new WebDriverWait(driver, Duration.ofSeconds(20));
        longWait.until(ExpectedConditions.elementToBeClickable(By.name("first_name"))).sendKeys("Jane");
        driver.findElement(By.id("submit")).click();
    ...
    public void testExternalLinkPrivacyPolicy() {
        ...
        WebDriverWait longWait = new WebDriverWait(driver, Duration.ofSeconds(20));
        WebElement link = longWait.until(ExpectedConditions.elementToBeClickable(By.partialLinkText("Privacy Policy")));
    ...
    public void testExternalLinkTermsOfService() {
        ...
        WebDriverWait longWait = new WebDriverWait(driver, Duration.ofSeconds(20));
        WebElement link = longWait.until(ExpectedConditions.elementToBeClickable(By.partialLinkText("Terms of Service")));
        String originalWindow = driver.getWindowHandle();
        link.click();
    ...
    public void testResetFormClearsFields() {
        ...
        WebDriverWait longWait = new WebDriverWait(driver, Duration.ofSeconds(20));
        longWait.until(ExpectedConditions.elementToBeClickable(By.name("first_name"))).sendKeys("Test");
    ...
    public void testDropdownCountrySelection() {
        ...
        WebDriverWait longWait = new WebDriverWait(driver, Duration.ofSeconds(20));
        WebElement countrySelect = longWait.until(ExpectedConditions.presenceOfElementLocated(By.id("country")));
        countrySelect.click();
        ...
        Assertions.assertEquals("United States", selected, "Selected country should be United States");
    }
}