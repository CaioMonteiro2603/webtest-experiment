...
public class DEMOAUT {
    ...
    public void testFormPresence() {
        ...
        Assertions.assertAll(
                () -> Assertions.assertTrue(driver.findElement(By.id("firstName")).isDisplayed(), "First name field should be visible"),
                () -> Assertions.assertTrue(driver.findElement(By.id("lastName")).isDisplayed(), "Last name field should be visible"),
