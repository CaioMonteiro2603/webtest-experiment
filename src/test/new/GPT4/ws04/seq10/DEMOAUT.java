...
public class DEMOAUT {
    ...
    public void testPageTitleAndHeader() {
        Assertions.assertTrue(driver.getTitle().contains("Request information"), "Title should contain 'Request information'");
    ...
    public void testRadioButtons() {
        driver.navigate().refresh();
        WebElement male = driver.findElement(By.id("radio-male"));
        WebElement female = driver.findElement(By.id("radio-female"));
        male.click();
    ...
    public void testCheckboxes() {
        driver.navigate().refresh();
        WebElement bike = driver.findElement(By.id("checkbox-bike"));
