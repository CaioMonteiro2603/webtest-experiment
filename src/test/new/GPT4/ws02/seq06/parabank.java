...
public class parabank {
    ...
    public void testOpenAboutPage() {
        ...
        aboutLink.click();
        wait.until(ExpectedConditions.titleContains("ParaSoft Demo Website"));
        Assertions.assertEquals("ParaSoft Demo Website", driver.getTitle(), "Should navigate to About Us page.");
    }
    ...
    public void testOpenServicesPage() {
        ...
        Assertions.assertTrue(driver.getTitle().contains("Services"), "Should navigate to Services page.");
    }
