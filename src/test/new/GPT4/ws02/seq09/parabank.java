...
public class parabank {
    ...
    public void testValidLogin() {
        ...
        Assertions.assertTrue(driver.findElement(By.xpath("//a[contains(text(),'Log Out')]")).isDisplayed(), "Logout link should be visible after login");
    }
    ...
    public void testAccountOverviewPage() {
        login(USERNAME, PASSWORD);
        WebElement accountOverviewLink = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(text(),'Accounts Overview')]")));
    ...
    public void testFooterTwitterLink() {
        ...
        WebElement twitterLink = longWait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='twitter.com']")));
        twitterLink.click();
    ...
    public void testFooterFacebookLink() {
        driver.get(BASE_URL);
        WebDriverWait longWait = new WebDriverWait(driver, Duration.ofSeconds(20));
        WebElement facebookLink = longWait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='facebook.com']")));
        facebookLink.click();
    ...
    public void testFooterLinkedInLink() {
        driver.get(BASE_URL);
        WebDriverWait longWait = new WebDriverWait(driver, Duration.ofSeconds(20));
        WebElement linkedinLink = longWait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='linkedin.com']")));
        linkedinLink.click();
    ...
    public void testLogoutFunctionality() {
        login(USERNAME, PASSWORD);
        WebElement logoutLink = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(text(),'Log Out')]")));
        logoutLink.click();
