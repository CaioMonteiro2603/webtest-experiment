...
public class JSFIDDLE {
    ...
    public void testStartFiddleButtonNavigates() {
        driver.get(BASE_URL);
        WebElement startButton = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Start Fiddling")));
        startButton.click();
        ...
        Assertions.assertTrue(htmlEditor.isDisplayed(), "HTML editor should be visible after clicking Start Fiddling");
    }
    ...
    public void testSearchFunctionality() {
        ...
        WebElement searchBox = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("input[placeholder='Search fiddles...'], input[type='search']")));
    ...
    public void testNewFiddleEditorLoads() {
        driver.get(BASE_URL);
        WebElement newFiddle = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Start Fiddling")));
        newFiddle.click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("div#id_code_html")));
        WebElement htmlEditor = driver.findElement(By.cssSelector("div#id_code_html"));
    ...
    public void testSupportLink() {
        driver.get(BASE_URL);
        WebElement supportLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("footer a[href*='github.com/jsfiddle']")));
