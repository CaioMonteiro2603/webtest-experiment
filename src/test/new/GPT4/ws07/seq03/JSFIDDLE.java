...
public class JSFIDDLE {
    ...
    public void testExploreLink() {
        WebElement explore = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(@href, '/explore')]")));
        explore.click();
    ...
    public void testDocsLink() {
        WebElement docs = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(@href, 'docs')]")));
        ...
        Assertions.assertTrue(driver.getCurrentUrl().contains("docs"), "Docs external link failed.");
        driver.close();
    ...
    public void testGitHubLink() {
        WebElement github = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(@href, 'github.com/jsfiddle')]")));
        String originalWindow = driver.getWindowHandle();
    ...
    public void testTwitterLink() {
        WebElement twitter = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(@href, 'twitter.com/jsfiddle') or contains(@href, 'x.com/jsfiddle')]")));
        String originalWindow = driver.getWindowHandle();
        ...
        wait.until(ExpectedConditions.or(
            ExpectedConditions.urlContains("twitter.com"),
            ExpectedConditions.urlContains("x.com")
        ));
        String currentUrl = driver.getCurrentUrl();
        boolean isTwitter = currentUrl.contains("twitter.com") || currentUrl.contains("x.com");
        Assertions.assertTrue(isTwitter, "Twitter external link failed.");
        driver.close();
        driver.switchTo().window(originalWindow);
    }
    ...
    public void testTryEditorWithoutLogin() {
        WebElement htmlPanel = wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(".panel-html, #panel_html, [data-panel='html']")));
