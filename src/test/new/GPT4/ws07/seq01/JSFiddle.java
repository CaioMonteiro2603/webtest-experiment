...
public class JSFiddle {
    ...
    public void testHomePageLoads() {
        ...
        Assertions.assertTrue(header.isDisplayed(), "Header should be displayed on homepage.");
    }
    ...
    public void testRegisterLinkNavigation() {
        driver.get(BASE_URL);
        WebElement registerLink = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Sign up")));
        registerLink.click();
