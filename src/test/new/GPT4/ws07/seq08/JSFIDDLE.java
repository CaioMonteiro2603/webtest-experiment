...
public class JSFIDDLE {
    ...
    public void testHomePageLoads() {
        driver.get(BASE_URL);
        WebElement logo = wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("a[href*='jsfiddle.net']")));
    ...
    public void testLoginLinkNavigatesToLoginPage() {
        driver.get(BASE_URL);
        WebElement loginLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='/user/login']")));
        loginLink.click();
        wait.until(ExpectedConditions.urlContains("/user/login"));
        Assertions.assertTrue(driver.getCurrentUrl().contains("/user/login"), "URL should contain /user/login after clicking login");
    ...
    public void testExternalLinkTermsOfService() {
        driver.get(BASE_URL);
        WebElement tosLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='/terms']")));
        tosLink.click();
