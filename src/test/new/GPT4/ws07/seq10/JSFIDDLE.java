...
public class JSFIDDLE {
    ...
    public void testHomePageLoads() {
        ...
        Assertions.assertTrue(driver.findElements(By.cssSelector("footer")).size() > 0 || driver.findElements(By.cssSelector(".footer")).size() > 0 || driver.findElement(By.tagName("body")).getText().toLowerCase().contains("jsfiddle"), "Footer should exist");
    }
