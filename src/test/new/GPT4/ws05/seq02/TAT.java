...
public class TAT {
    ...
    public void testHomePageLoad() {
        ...
        Assertions.assertEquals("CAC TAT", heading.getText(), "Page heading mismatch");
    }
    ...
    public void testPageTitle() {
        ...
        Assertions.assertEquals("Central de Atendimento ao Cliente TAT", title, "Page title mismatch");
    }
}