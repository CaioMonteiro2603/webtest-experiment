...
public class RESTFULL {
    ...
    public void testSubmitContactFormWithoutDataShowsError() {
        ...
        submitButton.click();
        WebElement error = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("span.error-message")));
    ...
    public void testRoomsPageLoads() {
        ...
        WebElement roomHeader = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("h2")));
    ...
    public void testBookButtonOpensModal() {
        driver.get(BASE_URL + "#rooms");
        WebElement bookButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button.btn")));// first visible button
        bookButton.click();
