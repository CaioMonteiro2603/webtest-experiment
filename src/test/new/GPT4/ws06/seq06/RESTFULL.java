...
public class RESTFULL {
    ...
    public void testHomePageLoads() {
        driver.get(BASE_URL);
        WebElement heading = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("div.container.h-100 div.row.h-100.align-items-center h1")));
    ...
    public void testRoomsSectionPresent() {
        ...
        Assertions.assertEquals("Our Rooms", roomsHeader.getText(), "Rooms section should be present on homepage");
    }
    ...
    public void testContactFormSubmissionWithValidData() {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.id("email"))).sendKeys("testuser@example.com");
    ...
    public void testContactFormSubmissionWithInvalidEmail() {
        ...
        WebElement nameField = wait.until(ExpectedConditions.elementToBeClickable(By.id("name")));
        nameField.sendKeys("Test User");
        wait.until(ExpectedConditions.elementToBeClickable(By.id("email"))).sendKeys("invalid-email");
        driver.findElement(By.id("phone")).sendKeys("1234567890");
        driver.findElement(By.id("subject")).sendKeys("Test Subject");
    ...
    public void testExternalLinkTwitter() {
        ...
        WebElement twitterLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("div.col-sm-6.text-center.social a[href*='twitter.com']")));
        twitterLink.click();
    ...
    public void testExternalLinkFacebook() {
        driver.get(BASE_URL);
        String originalWindow = driver.getWindowHandle();
        WebElement facebookLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("div.col-sm-6.text-center.social a[href*='facebook.com']")));
        facebookLink.click();
    ...
    public void testExternalLinkLinkedIn() {
        driver.get(BASE_URL);
        String originalWindow = driver.getWindowHandle();
        WebElement linkedinLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("div.col-sm-6.text-center.social a[href*='linkedin.com']")));
        linkedinLink.click();
    ...
    public void testBookNowModalOpens() {
        driver.get(BASE_URL);
        WebElement bookButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button.btn.btn-primary.book-room")));
        bookButton.click();

        WebElement modal = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".popup-overlay")));
