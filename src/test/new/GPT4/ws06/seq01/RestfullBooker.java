...
public class RestfullBooker {
    ...
    public void testHomePageLoads() {
        ...
        Assertions.assertTrue(headerText.contains("room") || headerText.contains("booking") || headerText.contains("hotel"), "Header should mention rooms or booking.");
    }
    ...
    public void testNavigateToRooms() {
        driver.get(BASE_URL);
        WebElement roomsNav = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[data-automationid='roomNavLink']")));
        roomsNav.click();
    ...
    public void testBookRoomFormPresent() {
        driver.get(BASE_URL);
        WebElement bookButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button[data-automationid='bookRoomBtn']")));
        bookButton.click();
    ...
    public void testContactFormValidationError() {
        ...
        WebElement submitBtn = driver.findElement(By.cssSelector("button[type='submit'][data-automationid='submitContact']"));
