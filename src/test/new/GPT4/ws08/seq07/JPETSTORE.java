...
public class JPETSTORE {
    ...
    public void testCategoryNavigation() {
        ...
        WebElement fishLink = wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("map[name='QuickLinks'] area[alt='Fish']")));
    ...
    public void testExternalAspectranLink() {
        ...
        WebElement link = wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("a[href*='aspectran.com']")));
        JavascriptExecutor js = (JavascriptExecutor) driver;
