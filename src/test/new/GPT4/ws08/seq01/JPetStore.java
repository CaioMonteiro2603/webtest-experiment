...
public class JPetStore {
    ...
    public void testHomePageLoads() {
        driver.get(BASE_URL);
        WebElement logo = wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("div#Logo")));
        Assertions.assertTrue(logo.findElement(By.tagName("img")).isDisplayed(), "Home page logo should be visible.");
    }
    ...
    public void testFooterExternalLink() {
        ...
        WebElement aspectranLink = wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#Footer a")));
        String href = aspectranLink.getAttribute("href");
        if (href != null && href.contains("aspectran.com")) {
            String originalWindow = driver.getWindowHandle();
            js.executeScript("arguments[0].click();", aspectranLink);
            ...
            Assertions.fail("External aspectran.com link not found in footer.");
        }
    }
    ...
    public void testProductCategoryNavigation() {
        ...
        JavascriptExecutor js = (JavascriptExecutor) driver;
        js.executeScript("arguments[0].click();", fishLink);
    ...
    public void testProductAddToCartAndRemove() {
        driver.get(BASE_URL + "catalog/");
        WebElement dogsLink = wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("area[alt='Dogs']")));
        JavascriptExecutor js = (JavascriptExecutor) driver;
        js.executeScript("arguments[0].click();", dogsLink);
