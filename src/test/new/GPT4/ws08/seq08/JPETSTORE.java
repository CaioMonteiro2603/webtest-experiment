...
public class JPETSTORE {
    ...
    public void testHomePageLoads() {
        driver.get(BASE_URL);
        WebElement welcome = wait.until(ExpectedConditions.visibilityOfElementLocated(By.tagName("h2")));
    ...
    public void testSignInPageLoads() {
        ...
        WebElement signInForm = wait.until(ExpectedConditions.presenceOfElementLocated(By.tagName("form")));
    ...
    public void testAddItemToCart() {
        ...
        WebElement item = wait.until(ExpectedConditions.presenceOfElementLocated(By.partialLinkText("EST-1")));
        item.click();
    ...
    public void testUpdateCartQuantity() {
        driver.get(BASE_URL + "catalog/products/FI-SW-01");
        wait.until(ExpectedConditions.elementToBeClickable(By.partialLinkText("EST-1"))).click();
    ...
    public void testExternalLinkAspectranOpensCorrectly() {
        driver.get(BASE_URL);
        WebElement footerLink = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[contains(@href, 'aspectran.com')]")));
