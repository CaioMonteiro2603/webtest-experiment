...
public class JPETSTORE {
    ...
    public void navigateToHome() {
        driver.get(BASE_URL);
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("MainImageContent")));
    }
    ...
    public void testHomePageLoads() {
        ...
        WebElement logo = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("MainImageContent")));
    ...
    public void testHelpExternalLink() {
        WebElement helpLink = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("?")));
