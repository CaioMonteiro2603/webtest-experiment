...
public class BrasilAgritest {
    ...
    public void crawlOneLevelBelowBase_InternalPagesReachable() {
        ...
        for (WebElement a : driver.findElements(By.cssSelector("a[href]"))) {
            ...
            if (!href.startsWith("https://www.brasilagri.com.br")) continue;
        ...
        for (String url : oneLevel) {
            ...
            waitForPageReady();
            Assertions.assertTrue(driver.getCurrentUrl().startsWith("https://www.brasilagri.com.br"), "Should stay within the same domain");
            visited++;
