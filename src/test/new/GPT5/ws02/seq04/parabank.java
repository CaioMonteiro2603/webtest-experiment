...
public class parabank {
    ...
    public void testOpenNewAccount() {
        ...
        Assertions.assertTrue(newAccHeader.getText().toLowerCase().contains("account opened") || newAccHeader.getText().toLowerCase().contains("opened"), "Expected 'Account Opened!' header.");
    ...
    public void testTransferFunds() {
        ...
        Assertions.assertTrue(h1.getText().toLowerCase().contains("transfer complete") || h1.getText().toLowerCase().contains("complete"), "Expected 'Transfer Complete!' message.");
    ...
    public void testBillPay() {
        ...
        driver.findElement(By.name("payee.name")).sendKeys("Electric Co");
        driver.findElement(By.name("payee.address.street")).clear();
        driver.findElement(By.name("payee.address.street")).sendKeys("1 Power Way");
        driver.findElement(By.name("payee.address.city")).clear();
        driver.findElement(By.name("payee.address.city")).sendKeys("Grid City");
        driver.findElement(By.name("payee.address.state")).clear();
        driver.findElement(By.name("payee.address.state")).sendKeys("GC");
        driver.findElement(By.name("payee.address.zipCode")).clear();
        driver.findElement(By.name("payee.address.zipCode")).sendKeys("99999");
        driver.findElement(By.name("payee.phoneNumber")).clear();
        driver.findElement(By.name("payee.phoneNumber")).sendKeys("5559999");
        ...
        driver.findElement(By.name("amount")).sendKeys("12.34");
        Select from = new Select(driver.findElement(By.name("fromAccountId")));
        if (from.getOptions().size() > 0) from.selectByIndex(0);
    ...
    public void testUpdateProfile() {
        ...
        WebElement h1 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#rightPanel h1")));
        Assertions.assertTrue(h1.getText().toLowerCase().contains("profile updated") || h1.getText().toLowerCase().contains("updated"), "Expected 'Profile Updated' confirmation.");
    }
    ...
    public void testRequestLoan() {
        ...
        WebElement h1 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#rightPanel h1")));
        Assertions.assertTrue(h1.getText().toLowerCase().contains("loan request processed") || h1.getText().toLowerCase().contains("processed"), "Expected loan request processed page.");
