...
public class saucedemo {
    ...
    private void resetAppStateIfAvailable() {
        ...
        closeButtons = driver.findElements(By.cssSelector(".bm-cross-button"));
        if (!closeButtons.isEmpty()) {
            closeMenu();
        }
    }
    ...
    public void testSortingDropdownChangesOrderByNameAndPrice() {
        ...
        // sort by Name (Z to A)
        WebElement sortEl = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".product_sort_container")));
