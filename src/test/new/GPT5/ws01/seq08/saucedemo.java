...
public class saucedemo {
    ...
    public void testSortingDropdownAllOptions() {
        ...
        // Click sorting dropdown to make it stable
        WebElement sortSelect = wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("select.product_sort_container")));
        sortSelect.click();
    ...
    public void testMenuOpenClose() {
        ...
        cross.click();
        wait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector("div.bm-menu-wrap")));
        Assertions.assertEquals(0, driver.findElements(By.cssSelector("button#react-burger-cross-btn")).size(), "Menu should be closed");
    }
    ...
    public void testFooterSocialLinksExternal() {
        ...
        Assertions.assertTrue(driver.getCurrentUrl().contains("twitter.com") || driver.getCurrentUrl().contains("x.com"), "Twitter link should open twitter.com or x.com");
