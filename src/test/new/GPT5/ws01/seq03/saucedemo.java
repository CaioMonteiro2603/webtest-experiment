...
public class saucedemo {
    ...
    public void testLoginPageLoads() {
        Assertions.assertTrue(driver.getCurrentUrl().contains("saucedemo.com"), "Base login URL should contain saucedemo.com");
    ...
    public void testInvalidLoginShowsError() {
        ...
        Assertions.assertTrue(driver.getCurrentUrl().contains("saucedemo.com/"), "Should remain on login after invalid attempt");
    }
    ...
    public void testSortingDropdownAllOptionsAffectOrder() {
        ...
        WebElement sortElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("select.product_sort_container")));
    ...
    public void testFooterSocialLinksExternal() {
        ...
        expectedDomains.put("Twitter", "x.com");
    ...
    public void testLogoutFromMenu() {
        ...
        Assertions.assertTrue(driver.getCurrentUrl().contains("saucedemo.com/"), "Should be back on login page after logout");
