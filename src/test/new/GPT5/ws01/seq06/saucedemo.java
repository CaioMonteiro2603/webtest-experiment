...
public class saucedemo {
    ...
    public void testLoginPageVisible() {
        ...
        Assertions.assertTrue(driver.getCurrentUrl().contains("index.html") || driver.getCurrentUrl().equals(BASE_URL), "URL should be login page");
    }
    ...
    public void testSortingDropdownAllOptions() {
        ...
        // Name (A to Z)
        WebElement sortElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("product_sort_container")));
        ...
        // Name (Z to A)
        sortElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("product_sort_container")));
    ...
    public void testFooterSocialLinksExternal() {
        ...
        // Make sure menu is closed before trying to click footer links
        closeMenuIfOpen();
        ...
        for (WebElement link : socialLinks) {
            ...
            // Use JavaScript click to avoid element obscured issue
