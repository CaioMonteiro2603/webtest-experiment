...
public class JSFiddle {
    ...
    void base_Should_Load_And_Render_Header_And_Footer() {
        ...
        Assertions.assertAll("Core sections",
                ...
                () -> Assertions.assertTrue(present(By.cssSelector("footer, .footer, #footer")), "Footer should exist"),
    ...
    void header_Navigation_Internal_Links_One_Level() {
        ...
        for (WebElement a : links) {
            ...
            if (href.startsWith("#")) {
                ...
                tested++;
            } else if (host == null || host.isEmpty() || host.equalsIgnoreCase(baseHost) || href.startsWith("/")) {
    ...
    void external_Links_In_Footer_Should_Open_And_Have_Expected_Domain() {
        ...
        for (WebElement a : external) {
            ...
            if (host == null || host.isEmpty() || domains.contains(host)) continue;
            domains.add(host);
    ...
    void create_New_Fiddle_Entry_Point_If_Available() {
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(BODY));
        String after = driver.getCurrentUrl();
        Assertions.assertTrue(!after.equals(before) || after.contains("#") || after.contains("create") || after.contains("new"),
        ...
        List<String> internal = driver.findElements(ANY_LINK).stream()
                ...
                .filter(href -> {
                    ...
                    return href.startsWith("#") || href.startsWith("/")
                            || (host == null || host.isEmpty()) || host.equalsIgnoreCase(baseHost)
