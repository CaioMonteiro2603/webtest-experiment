...
public class RestfullBooker {
    ...
    public void navigateToContactSection() {
        ...
        WebElement formHeader = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#contact h2, section[id*='contact'] h2, div[class*='contact'] h2")));
    ...
    public void navigateToRoomsSectionAndValidateCards() {
        ...
        List<WebElement> cards = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.cssSelector("#rooms .room-info, #rooms .row .col-sm-4, div[class*='room']")));
        Assertions.assertFalse(cards.isEmpty(), "At least one room card should be present");
        WebElement firstCard = cards.get(0);
        WebElement title = firstCard.findElement(By.cssSelector("h3, h2, .room-name, div[class*='title']"));
    ...
    public void openFirstRoomDetailsOrBooking() {
        ...
        List<WebElement> bookButtons = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.cssSelector("#rooms .room-info .btn-primary, #rooms .room-info a, #rooms .room-info button, div[class*='room'] .btn-primary, div[class*='room'] a, div[class*='room'] button")));
