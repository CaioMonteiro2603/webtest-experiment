...
public class RestfullBooker {
    ...
    public void homePageLoads_CoreElementsPresent() {
        ...
        WebElement header = firstDisplayed(By.cssSelector("h1"), By.cssSelector("header h1"), By.cssSelector(".container h1"));
        WebElement contactForm = firstDisplayed(By.id("contact"), By.cssSelector("section#contact"), By.cssSelector("h2"));
        WebElement rooms = firstDisplayed(By.id("rooms"), By.cssSelector("section#rooms"), By.cssSelector(".row.room"));
    ...
    public void contactForm_SubmitEmpty_ShowsValidationErrors() {
        goHome();
        WebElement submit = firstDisplayed(By.id("submitContact"), By.cssSelector("#contact button[type='submit']"), By.xpath("//section[@id='contact']//button"), By.cssSelector("button[value='Submit']"), By.cssSelector("button[type='submit']"));
    ...
    public void contactForm_ValidSubmission_ShowsSuccess() {
        ...
        WebElement submit = firstDisplayed(By.id("submitContact"), By.cssSelector("#contact button[type='submit']"), By.cssSelector("button[value='Submit']"), By.cssSelector("button[type='submit']"));
        Assertions.assertNotNull(submit, "Contact submit button must exist");
        safeClick(submit);
    ...
    public void rooms_FirstRoom_BookFlow_AlertShown() {
        ...
        WebElement roomsSection = firstDisplayed(By.id("rooms"), By.cssSelector("section#rooms"), By.cssSelector(".row.room"), By.cssSelector(".room"));
    ...
    public void ensure_PageStable_AfterMutations() {
        ...
        WebElement rooms = firstDisplayed(By.id("rooms"), By.cssSelector("section#rooms"), By.cssSelector(".row.room"), By.cssSelector(".room"));
        WebElement contact = firstDisplayed(By.id("contact"), By.cssSelector("section#contact"), By.cssSelector(".contact"));
        Assertions.assertAll(
