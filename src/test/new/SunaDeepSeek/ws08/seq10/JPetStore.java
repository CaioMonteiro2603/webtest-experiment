...
public class JPetStore {
    ...
    public void testProductDetailsPage() {
        ...
        WebElement firstProduct = wait.until(ExpectedConditions.elementToBeClickable(
            By.cssSelector("#Catalog table tr:nth-child(2) td a")));
    ...
    public void testExternalLinks() {
        ...
        for (String linkSelector : externalLinks) {
            List<WebElement> links = driver.findElements(By.cssSelector(linkSelector));
            if (links.size() > 0) {
                WebElement externalLink = wait.until(ExpectedConditions.elementToBeClickable(links.get(0)));
                externalLink.click();
