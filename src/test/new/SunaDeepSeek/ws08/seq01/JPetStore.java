...
public class JPetStore {
    ...
    public void testCategoryNavigation() {
        ...
        for (WebElement category : categories) {
            ...
            categories = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(
                By.cssSelector("#SidebarContent a")));
        }
    }
    ...
    public void testExternalLinks() {
        ...
        try {
            ...
            // Skip if twitter link not found
        }
        ...
        try {
            ...
            // Skip if facebook link not found
        }
    }
    ...
    private void loginWithDirectNavigation() {
        driver.get(BASE_URL + "actions/Account.action?signonForm=");
