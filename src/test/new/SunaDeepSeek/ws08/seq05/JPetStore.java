...
public class JPetStore {
    ...
    public void testProductPages() {
        ...
        // Test product link - fix selector to target first product link
    ...
    public void testItemPages() {
        ...
        // Test item link - fix selector to target first item link
    ...
    public void testLoginFunctionality() {
        ...
        // Valid login - fix login button selector
    ...
    public void testExternalLinks() {
        ...
        // Test Twitter link - fix selector to match actual footer links
    ...
    public void testCartFunctionality() {
        // Login first - fix login button selector
        driver.get(BASE_URL + "account/signonForm");
        WebElement usernameField = wait.until(ExpectedConditions.presenceOfElementLocated(By.name("username")));
        WebElement passwordField = driver.findElement(By.name("password"));
        WebElement loginButton = driver.findElement(By.cssSelector("input[type='submit']"));
        ...
        // Add to cart - fix selector to target add to cart link
        WebElement addToCartButton = wait.until(ExpectedConditions.elementToBeClickable(
                By.cssSelector("#Catalog a[href*='addItemToCart']")));
