...
public class conduit {
    ...
    public void testExternalLinks() {
        ...
        WebElement footerElement = wait.until(ExpectedConditions.presenceOfElementLocated(By.tagName("footer")));
        WebElement twitterLink = footerElement.findElement(By.cssSelector("a[href*='twitter']"));
        twitterLink.click();
