...
public class conduit {
    ...
    public void testHomePageLoads() {
        ...
        Assertions.assertTrue(driver.getTitle().toLowerCase().contains("conduit") || driver.getTitle().toLowerCase().contains("demo"));
    ...
    public void testSuccessfulLogin() {
        ...
        wait.until(ExpectedConditions.urlContains("/#/"));
        WebElement userProfile = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a.nav-link[href='/#/@testuser123']")));
    ...
    public void testInvalidLogin() {
        ...
        Assertions.assertTrue(errorMessage.getText().toLowerCase().contains("email") && errorMessage.getText().toLowerCase().contains("password"));
    }
    ...
    public void testArticleNavigation() {
        ...
        if (articles.size() > 0) {
            WebElement firstArticle = articles.get(0).findElement(By.cssSelector(".preview-link"));
    ...
    public void testUserProfileNavigation() {
        ...
        WebElement profileLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a.nav-link[href='/#/@testuser123']")));
        profileLink.click();
        
        wait.until(ExpectedConditions.urlContains("/#/"));
        WebElement profileHeader = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".user-info h4")));
        Assertions.assertTrue(profileHeader.getText().toLowerCase().contains(USERNAME.toLowerCase()));
    }
