...
public class parabank {
    ...
    public void testSuccessfulLogin() {
        ...
        WebElement welcomeMessage = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//h1[@class='title' or contains(text(),'Welcome')]")));
    ...
    public void testFooterLinks() {
        ...
        testFooterLink("Products", "products");
