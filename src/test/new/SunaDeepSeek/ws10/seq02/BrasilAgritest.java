...
public class BrasilAgritest {
    ...
    public void testSuccessfulLogin() {
        ...
        Assertions.assertTrue(driver.getCurrentUrl().contains("gestao.brasilagritest.com"), "Login failed - not redirected to dashboard");
    }
    ...
    public void testNavigationMenu() {
        ...
        WebElement menuButton = wait.until(ExpectedConditions.elementToBeClickable(
            By.cssSelector(".navbar-toggler, .menu-toggle, button[data-toggle='collapse']")));
        menuButton.click();
        
        // Wait for menu to be visible
        WebElement menu = wait.until(ExpectedConditions.visibilityOfElementLocated(
            By.cssSelector(".navbar-collapse, .sidebar, .menu")));
    ...
    public void testLogout() {
        ...
        WebElement logoutLink = wait.until(ExpectedConditions.elementToBeClickable(
            By.cssSelector("a[href*='logout'], .logout, .logout-link, a:contains('Sair'), a:contains('Logout')")));
        logoutLink.click();
