...
public class DemoAUT {
    ...
    public void testRequiredFieldValidation() {
        ...
        Assertions.assertTrue(validationMessage.contains("Please fill out this field"));
    }
    ...
    public void testRadioButtons() {
        ...
        WebElement radio1 = wait.until(ExpectedConditions.elementToBeClickable(By.id("radio-button-1")));
        radio1.click();
