...
public class RestfullBooker {
    ...
    public void testContactFormSubmission() {
        ...
        WebElement contactButton = wait.until(ExpectedConditions.elementToBeClickable(
            By.cssSelector("button.btn.btn-primary[data-target*='Contact']")));
        contactButton.click();
    ...
    public void testAdminLogin() {
        ...
        WebElement logoutButton = wait.until(ExpectedConditions.elementToBeClickable(
            By.cssSelector("button[data-testid='logout-button']")));
    ...
    public void testRoomBookingFlow() {
        ...
        WebElement bookButton = wait.until(ExpectedConditions.elementToBeClickable(
            By.cssSelector("button.btn.btn-outline-primary")));
        bookButton.click();
        ...
        WebElement bookNowButton = driver.findElement(By.cssSelector("button.btn.btn-primary"));
        bookNowButton.click();
