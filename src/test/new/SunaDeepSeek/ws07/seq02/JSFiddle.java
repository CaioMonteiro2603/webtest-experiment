...
public class JSFiddle {
    ...
    public void testHomePageLoad() {
        ...
        WebElement logo = wait.until(ExpectedConditions.presenceOfElementLocated(
            By.cssSelector("a.AnchorLogo_link__Eybe9")));
    ...
    public void testEditorPageElements() {
        ...
        WebElement htmlPanel = wait.until(ExpectedConditions.presenceOfElementLocated(
            By.cssSelector(".LayoutPanel_HTML")));
        Assertions.assertTrue(htmlPanel.isDisplayed(), "HTML panel should be visible");
        
        WebElement cssPanel = driver.findElement(By.cssSelector(".LayoutPanel_CSS"));
        Assertions.assertTrue(cssPanel.isDisplayed(), "CSS panel should be visible");
        
        WebElement jsPanel = driver.findElement(By.cssSelector(".LayoutPanel_Javascript"));
        Assertions.assertTrue(jsPanel.isDisplayed(), "JS panel should be visible");
        
        WebElement resultPanel = driver.findElement(By.cssSelector(".LayoutPanel_Result"));
    ...
    public void testRunButtonFunctionality() {
        ...
        WebElement runButton = wait.until(ExpectedConditions.elementToBeClickable(
            By.cssSelector("button.Buttons_runButton")));
        runButton.click();
    ...
    public void testFooterLinks() {
        ...
        // Test Twitter link
        testExternalFooterLink("Twitter", "a[href*='twitter']", "twitter.com");
        
        // Test GitHub link
        testExternalFooterLink("GitHub", "a[href*='github']", "github.com");
    }
    ...
    public void testLoginModal() {
        ...
        WebElement loginButton = wait.until(ExpectedConditions.elementToBeClickable(
            By.cssSelector("a.Buttons_loginButton")));
        loginButton.click();
        
        WebElement modal = wait.until(ExpectedConditions.visibilityOfElementLocated(
            By.cssSelector(".Modal_content")));
        ...
        // Close modal
        WebElement closeButton = driver.findElement(By.cssSelector(".Modal_closeButton"));
        closeButton.click();
