...
public class TAT {
    ...
    public void testLoginPage() {
        driver.get(BASE_URL);
        Assertions.assertTrue(driver.getCurrentUrl().contains("index.html"), "Should be on login page");
    ...
    public void testInvalidLogin() {
        ...
        Assertions.assertTrue(errorMessage.getText().contains("Epic sadface"), 
