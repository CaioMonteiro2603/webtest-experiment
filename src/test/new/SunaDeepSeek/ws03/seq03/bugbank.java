...
public class bugbank {
    ...
    public void testLoginWithValidCredentials() {
        ...
        WebElement welcomeMessage = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//p[contains(text(),'Olá')]")));
    ...
    public void testLoginWithInvalidCredentials() {
        ...
        WebElement errorMessage = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[contains(text(),'Usuário ou senha inválido')]")));
    ...
    public void testMenuNavigation() {
        ...
        // Open menu
        WebElement menuButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[contains(text(),'menu')]")));
        menuButton.click();
        
        // Test All Items
        WebElement allItems = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(text(),'Todos')]")));
        allItems.click();
        Assertions.assertTrue(driver.getCurrentUrl().contains("bugbank"), "All Items navigation failed");
        
        // Test About (external)
        menuButton.click();
        WebElement about = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(text(),'Sobre')]")));
        about.click();
        ...
        // Test Logout
        menuButton.click();
        WebElement logout = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(text(),'Sair')]")));
        logout.click();
        Assertions.assertTrue(driver.getCurrentUrl().contains("bugbank"), "Logout failed");
    }
    ...
    public void testResetAppState() {
        ...
        WebElement menuButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[contains(text(),'menu')]")));
        menuButton.click();
        WebElement reset = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(text(),'Resetar')]")));
        reset.click();
    ...
    private void login() {
        ...
        passwordField.sendKeys(LOGIN_PASSWORD);
        loginButton.click();
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//p[contains(text(),'Olá')]")));
    }
