...
public class bugbank {
    ...
    public void testLogin() {
        ...
        WebElement accountInfo = wait.until(ExpectedConditions.presenceOfElementLocated(By.className("account-info")));
    ...
    public void testInvalidLogin() {
        ...
        Assertions.assertTrue(currentUrl.equals(BASE_URL) || currentUrl.contains("login"), "Error handling not working for invalid login");
    }
    ...
    private void login() {
        if (driver.getCurrentUrl().equals(BASE_URL)) {
            ...
            wait.until(ExpectedConditions.presenceOfElementLocated(By.className("account-info")));
        }
    }
}