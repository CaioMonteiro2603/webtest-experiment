...
public class saucedemo {
    ...
    public void testProductSorting() {
        ...
        // Test Name (A to Z)
        WebElement sortDropdown1 = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".product_sort_container")));
        sortDropdown1.click();
        ...
        // Test Name (Z to A)
        WebElement sortDropdown2 = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".product_sort_container")));
        sortDropdown2.click();
        ...
        WebElement sortDropdown3 = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".product_sort_container")));
        sortDropdown3.click();
        ...
        WebElement sortDropdown4 = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".product_sort_container")));
        sortDropdown4.click();
    ...
    public void testMenuNavigation() {
        ...
        List<WebElement> menuOpen = driver.findElements(By.cssSelector(".bm-menu.bm-menu--open"));
        if (!menuOpen.isEmpty()) {
            driver.findElement(By.cssSelector(".bm-cross-button")).click();
            wait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector(".bm-menu.bm-menu--open")));
        }
        
        // Open menu
        WebDriverWait longWait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement menuButton = longWait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".bm-burger-button")));
        ...
        // Close menu if it's open
        menuOpen = driver.findElements(By.cssSelector(".bm-menu.bm-menu--open"));
        if (!menuOpen.isEmpty()) {
            driver.findElement(By.cssSelector(".bm-cross-button")).click();
            wait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector(".bm-menu.bm-menu--open")));
        }
    ...
    public void testSocialLinks() {
        ...
        Assertions.assertTrue(driver.getCurrentUrl().contains("twitter.com") || driver.getCurrentUrl().contains("x.com"), "Twitter link not working");
        driver.close();
        driver.switchTo().window(originalWindow);
