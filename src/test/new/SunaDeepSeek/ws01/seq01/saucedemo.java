...
public class saucedemo {
    ...
    public void testProductSorting() {
        ...
        WebElement sortElement = wait.until(ExpectedConditions.presenceOfElementLocated(By.className("product_sort_container")));
        ...
        items = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.className("inventory_item_name")));
        ...
        items = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.className("inventory_item_price")));
    ...
    public void testFooterSocialLinks() {
        ...
        // Test Twitter link
        testFooterLink("social_twitter", "twitter.com");
        
        // Test Facebook link
        testFooterLink("social_facebook", "facebook.com");
        
        // Test LinkedIn link
        testFooterLink("social_linkedin", "linkedin.com");
    }

    private void testFooterLink(String linkId, String expectedDomain) {
        String originalWindow = driver.getWindowHandle();
