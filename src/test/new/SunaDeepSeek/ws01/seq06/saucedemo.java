...
public class saucedemo {
    ...
    public void testProductSorting() {
        ...
        List<WebElement> priceItems = wait.until(ExpectedConditions.numberOfElementsToBeMoreThan(
            By.className("inventory_item_price"), 0));
        Assertions.assertTrue(priceItems.get(0).getText().startsWith("$7.99"),
        ...
        priceItems = wait.until(ExpectedConditions.numberOfElementsToBeMoreThan(
            By.className("inventory_item_price"), 0));
        Assertions.assertTrue(priceItems.get(0).getText().startsWith("$49.99"),
    ...
    private void testExternalLink(String linkId, String expectedDomain) {
        ...
        WebElement link = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[data-test='" + linkId + "']")));
