...
public class saucedemo {
    ...
    public void testMenuOptions() {
        ...
        // Close menu if it's open first
        try {
            if (driver.findElement(By.className("bm-menu-wrap")).getAttribute("class").contains("menu-open")) {
                // Click outside or on close button to close menu
                driver.findElement(By.className("bm-cross-button")).click();
                Thread.sleep(500);
            }
        } catch (Exception e) {
            // Menu might not be open, continue
        }
        
        // Open menu
        wait.until(ExpectedConditions.elementToBeClickable(By.className("bm-burger-button"))).click();
