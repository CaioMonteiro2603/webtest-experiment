...
public class RestfullBooker {
    ...
    public void testRoomBooking() {
        ...
        WebElement bookButton = wait.until(ExpectedConditions.elementToBeClickable(
            By.cssSelector("button[onclick='window.scrollTo(0, 500);']")));
        bookButton.click();
        ...
        WebElement bookNowButton = driver.findElement(By.cssSelector("button[onclick='createBooking()']"));
    ...
    public void testAdminLogin() {
        ...
        WebElement username = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("#username")));
        ...
        WebElement dashboard = wait.until(ExpectedConditions.visibilityOfElementLocated(
            By.cssSelector("[data-testid='roomlisting']")));
    ...
    public void testFooterLinks() {
        ...
        WebElement githubLink = wait.until(ExpectedConditions.elementToBeClickable(
            By.cssSelector("a[href*='github.com/automationintesting']")));
    ...
    public void testRoomCount() {
        ...
        List<WebElement> rooms = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(
            By.cssSelector("[data-testid='roomtitle']")));
