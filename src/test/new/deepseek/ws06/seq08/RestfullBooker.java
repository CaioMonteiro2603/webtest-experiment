...
public class RestfullBooker {
    ...
    public void testHomePageLoading() {
        ...
        Assertions.assertTrue(header.getText().contains("Shady Meadows B&B"),
    ...
    public void testRoomInformation() {
        ...
        String roomDescription = firstRoom.findElement(By.cssSelector("p")).getText();
    ...
    public void testContactForm() {
        driver.get(BASE_URL);
        driver.findElement(By.cssSelector(".col-sm-8 h2")).click();
    ...
    public void testNavigationLinks() {
        ...
        // Test Admin link
        driver.findElement(By.linkText("Log into the hotel admin portal")).click();
        wait.until(ExpectedConditions.urlContains("admin"));
        Assertions.assertTrue(driver.getCurrentUrl().contains("admin"), 
            "Should navigate to admin page");
        
        // Test API link
        driver.findElement(By.linkText("Explore the API")).click();
        ...
        // Test Report link
        driver.findElement(By.linkText("Download the automation report")).click();
