...
public class RestfullBooker {
    ...
    public void testRoomBooking() {
        ...
        WebElement bookButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button.btn-primary")));
        bookButton.click();
        ...
        WebElement confirmation = wait.until(ExpectedConditions.presenceOfElementLocated(By.className("ReactModal__Content")));
    ...
    public void testContactForm() {
        ...
        WebElement contactButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button.btn-secondary")));
        contactButton.click();
    ...
    public void testLoginFunctionality() {
        ...
        WebElement username = wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("input[type='text']")));
        ...
        WebElement logoutButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button.btn-primary")));
