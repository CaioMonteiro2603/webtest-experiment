...
public class RestfullBooker {
    ...
    public void testRoomBooking() {
        driver.get(BASE_URL);
        WebElement bookButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".btn.btn-primary")));
        bookButton.click();
        ...
        WebElement submitButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".btn.btn-primary")));
    ...
    public void testContactFormSubmission() {
        driver.get(BASE_URL);
        WebElement contactButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button[data-target*='contact']")));
        contactButton.click();
