...
public class parabank {
    ...
    public void testLoginPage() {
        ...
        Assertions.assertTrue(driver.findElement(By.cssSelector(".smallText")).getText().contains("Welcome"));
    }
    ...
    public void testMenuNavigation() {
        ...
        logout.click();
        wait.until(ExpectedConditions.urlContains("index.htm"));
        Assertions.assertTrue(driver.findElement(By.cssSelector("h1.title")).getText().contains("Welcome"));
    ...
    public void testFooterSocialLinks() {
        ...
        // Test Facebook
        WebElement facebookLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='facebook']").tagName("a")));
        facebookLink.click();
        switchToNewWindowAndAssertDomain("facebook.com", originalWindow);

        // Test Twitter
        WebElement twitterLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='twitter']").tagName("a")));
        twitterLink.click();
        switchToNewWindowAndAssertDomain("twitter.com", originalWindow);

        // Test LinkedIn
        WebElement linkedinLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='linkedin']").tagName("a")));
        linkedinLink.click();
