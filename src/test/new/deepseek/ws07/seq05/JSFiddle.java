...
public class JSFiddle {
    ...
    public void testJsFiddleHomePage() {
        ...
        WebElement title = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("a.logo")));
    ...
    public void testLoginPage() {
        ...
        WebElement loginButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[title='Sign in']")));
        loginButton.click();

        WebElement emailField = wait.until(ExpectedConditions.elementToBeClickable(By.id("id_username")));
        ...
        WebElement errorMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".errornote")));
        Assertions.assertTrue(errorMessage.getText().contains("Please enter a correct username and password"), "Error message should indicate invalid credentials");
    }
