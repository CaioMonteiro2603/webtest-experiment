...
public class JSFiddle {
    ...
    public void testRunButton() {
        ...
        WebElement runButton = wait.until(ExpectedConditions.elementToBeClickable(
            By.cssSelector("button[class*='run']")));
        runButton.click();
    ...
    public void testExternalLinks() {
        ...
        WebElement twitterLink = wait.until(ExpectedConditions.elementToBeClickable(
            By.cssSelector("a[href*='twitter.com'], a[href*='x.com']")));
    ...
    public void testEditorTabs() {
        ...
        WebElement htmlTab = wait.until(ExpectedConditions.elementToBeClickable(
            By.cssSelector("a[title*='HTML'], .windowLabelWrapper:first-of-type, .panelControlBar > div:first-child")));
        htmlTab.click();
        ...
        WebElement cssTab = wait.until(ExpectedConditions.elementToBeClickable(
            By.cssSelector("a[title*='CSS'], .windowLabelWrapper:nth-child(2), .panelControlBar > div:nth-child(2)")));
        cssTab.click();
        ...
        WebElement jsTab = wait.until(ExpectedConditions.elementToBeClickable(
            By.cssSelector("a[title*='JavaScript'], .windowLabelWrapper:nth-child(3), .panelControlBar > div:nth-child(3)")));
        jsTab.click();
    ...
    public void testConsolePanel() {
        ...
        WebElement consoleTab = wait.until(ExpectedConditions.elementToBeClickable(
            By.cssSelector("a[title*='Console'], .windowLabelWrapper:nth-child(4), .panelControlBar > div:nth-child(4)")));
        consoleTab.click();
        
        WebElement consolePanel = wait.until(ExpectedConditions.visibilityOfElementLocated(
            By.cssSelector(".console, .console-panel, .console-container")));
    ...
    public void testSaveButton() {
        ...
        WebElement saveButton = wait.until(ExpectedConditions.elementToBeClickable(
            ...
            WebElement altSaveButton = wait.until(ExpectedConditions.elementToBeClickable(
        ...
        try {
            ...
            // If no login dialog appears, assume save worked without login
            Assertions.assertTrue(true, "Save operation completed");
        }
    }
}