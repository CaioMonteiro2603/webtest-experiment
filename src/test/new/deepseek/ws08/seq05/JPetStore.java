...
public class JPetStore {
    ...
    public void testCategoryNavigation() {
        ...
        WebElement fishCategory = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='categoryId=FISH']")));
        fishCategory.click();
    ...
    public void testProductNavigation() {
        ...
        WebElement productLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='productId=FI-SW-01']")));
        productLink.click();
    ...
    public void testAddToCart() {
        ...
        WebElement addToCartButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='/actions/Cart.action?addItemToCart=&workingItemId=EST-1']")));
        addToCartButton.click();
        
        wait.until(ExpectedConditions.urlContains("Cart.action"));
        Assertions.assertTrue(driver.findElement(By.cssSelector("td[colspan='2']")).getText().contains("Total"));
    }
    ...
    public void testInvalidLogin() {
        ...
        WebElement errorMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".messages")));
        Assertions.assertTrue(errorMessage.getText().toLowerCase().contains("invalid username or password"));
    }
