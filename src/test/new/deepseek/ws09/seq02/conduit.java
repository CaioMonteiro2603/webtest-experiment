...
public class conduit {
    ...
    public void testSuccessfulLogin() {
        ...
        WebElement email = wait.until(ExpectedConditions.elementToBeClickable(
            By_css_selector("input[type='email']")));
    ...
    public void testExternalLinks() {
        ...
        WebElement twitterLink = wait.until(ExpectedConditions.elementToBeClickable(
            By_css_selector("a[href*='twitter']")));
        twitterLink.click();
    ...
    private static By By_css_selector(String selector) {
        return By.cssSelector(selector.replaceAll("'", "\""));
    }
}