...
public class conduit {
    ...
    public void testHomePageNavigation() {
        ...
        WebElement homeLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href='#/']")));
        homeLink.click();
    ...
    public void testExternalLinks() {
        ...
        WebElement conduitLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href='https://github.com/gothinkster/realworld']")));
        conduitLink.click();
