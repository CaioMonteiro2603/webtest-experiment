...
public class DemoAUT {
    ...
    public void testRequiredFields() {
        ...
        WebElement genderError = driver.findElement(By.cssSelector(".radio-box + .error"));
    ...
    public void testHobbiesSelection() {
        driver.get(BASE_URL);
        driver.findElement(By.xpath("//label[text()='Read books']")).click();
        driver.findElement(By.xpath("//label[text()='Listening to music']")).click();
        Assertions.assertTrue(driver.findElement(By.xpath("//label[text()='Read books']/input")).isSelected());
        Assertions.assertTrue(driver.findElement(By.xpath("//label[text()='Listening to music']/input")).isSelected());
    }
