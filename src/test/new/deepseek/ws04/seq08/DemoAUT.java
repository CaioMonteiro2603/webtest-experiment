...
public class DemoAUT {
    ...
    public void testFormReset() {
        ...
        Assertions.assertEquals("", driver.findElement(By.id("last-name")).getAttribute("value"),
    ...
    public void testLinkNavigation() {
        ...
        // Wait for help link to be present and clickable
        WebElement helpLink = wait.until(ExpectedConditions.presenceOfElementLocated(By.linkText("Help Center")));
        wait.until(ExpectedConditions.elementToBeClickable(helpLink));
        helpLink.click();
        
        // Verify navigation
        wait.until(ExpectedConditions.urlContains("aut/html/help.html"));
        Assertions.assertTrue(driver.getCurrentUrl().contains("aut/html/help.html"),
