...
public class DemoAUT{
    ...
    public void testRadioButtonSelection() {
        driver.get(BASE_URL);
        WebElement genderFemale = wait.until(ExpectedConditions.elementToBeClickable(By.id("genderFemale")));
        genderFemale.click();

        Assertions.assertTrue(genderFemale.isSelected(), "Female radio button should be selected");
        Assertions.assertFalse(driver.findElement(By.id("genderMale")).isSelected(), "Male radio button should not be selected");
    }
    ...
    public void testDropdownOptions() {
        ...
        Assertions.assertEquals(4, roleSelect.getOptions().size(), "Should have 4 role options");
        Assertions.assertEquals("QA", roleSelect.getOptions().get(1).getText());
    }
    ...
    public void testExternalLinks() {
        ...
        WebElement katalonLink = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(text(), 'Katalon')]")));
        katalonLink.click();
