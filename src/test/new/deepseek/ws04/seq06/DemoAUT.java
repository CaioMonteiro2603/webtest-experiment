...
public class DemoAUT {
    ...
    public void testFormSubmission() {
        ...
        WebElement genderMale = driver.findElement(By.cssSelector("input[type='radio'][value='Male']"));
    ...
    public void testRequiredFieldsValidation() {
        ...
        WebElement firstNameError = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@id='first-name']/following-sibling::div[@class='invalid-feedback']")));
    ...
    public void testRadioButtonSelection() {
        driver.get(BASE_URL);
        WebElement genderFemale = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("input[type='radio'][value='Female']")));
        genderFemale.click();
    ...
    public void testExternalLinks() {
        driver.get(BASE_URL);
        WebElement katalonLink = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[text()='Katalon']")));
