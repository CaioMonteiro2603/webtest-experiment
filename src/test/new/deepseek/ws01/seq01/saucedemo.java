...
public class saucedemo {
    ...
    public void testSortingDropdown() {
        ...
        WebElement firstItem = wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("div.inventory_item_name")));
        String firstItemNameBeforeSort = firstItem.getText();
        
        sortingDropdown.selectByVisibleText("Name (Z to A)");
        wait.until(ExpectedConditions.not(ExpectedConditions.textToBePresentInElementLocated(By.cssSelector("div.inventory_item_name"), firstItemNameBeforeSort)));
        Assertions.assertNotEquals(firstItemNameBeforeSort, driver.findElement(By.cssSelector("div.inventory_item_name")).getText(), "First item name should change after sorting");
    ...
    public void testSocialLinks() {
        ...
        twitterLink.click();
        switchToNewWindowAndAssertDomain("x.com");
