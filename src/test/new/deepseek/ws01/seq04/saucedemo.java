...
public class saucedemo  {
    ...
    public void testInventorySorting() {
        ...
        // Re-find the dropdown element each time to avoid stale element reference
        Select sortDropdown = new Select(wait.until(ExpectedConditions.presenceOfElementLocated(By.className("product_sort_container"))));
        ...
        // Re-find dropdown for next selection
        sortDropdown = new Select(wait.until(ExpectedConditions.presenceOfElementLocated(By.className("product_sort_container"))));
    ...
    public void testSocialLinks() {
        ...
        // Test Twitter link
        testSocialLink("social_twitter", "twitter");
        // Test Facebook link
        testSocialLink("social_facebook", "facebook");
        // Test LinkedIn link
        testSocialLink("social_linkedin", "linkedin");
    }
