...
public class saucedemo {
    ...
    public void testInventorySorting() {
        ...
        WebElement sortElement = wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(".product_sort_container")));
    ...
    public void testMenuNavigation() {
        ...
        // Open menu again (close and reopen)
    ...
    public void testFooterSocialLinks() {
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.id("social_twitter")));
