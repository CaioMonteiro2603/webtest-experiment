...
public class saucedemo {
    ...
    public void testSortingDropdown() {
        ...
        // Wait for the page to fully load before interacting with dropdown
        wait.until(ExpectedConditions.presenceOfElementLocated(By.className("product_sort_container")));

        // Test Name (A to Z)
        WebElement dropdownElement = wait.until(ExpectedConditions.presenceOfElementLocated(By.className("product_sort_container")));
        ...
        // Test Name (Z to A) - Re-find dropdown element to avoid stale element
        dropdownElement = wait.until(ExpectedConditions.presenceOfElementLocated(By.className("product_sort_container")));
        sortDropdown = new Select(dropdownElement);
    ...
    public void testMenuNavigation() {
        ...
        // Wait for menu close button to not be present before opening menu
        ...
        // Open menu again - wait for it to close properly first
        wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("react-burger-cross-btn")));
        ...
        // Reset app state
        loginAndNavigateToInventory(); // Re-login to ensure clean state
        menuButton = wait.until(ExpectedConditions.elementToBeClickable(By.id("react-burger-menu-btn")));
        menuButton.click();
    ...
    private void testExternalLink(String linkId, String expectedDomain) {
        ...
        WebElement link = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(@class, '" + linkId + "') or @id='" + linkId + "']")));
        link.click();
    ...
    public void testLogout() {
        ...
        // Wait for menu to be closed before opening
        wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("react-burger-cross-btn")));
        WebElement menuButton = wait.until(ExpectedConditions.elementToBeClickable(By.id("react-burger-menu-btn")));
        menuButton.click();
        ...
        Assertions.assertTrue(driver.getCurrentUrl().contains("saucedemo.com") && !driver.getCurrentUrl().contains("inventory.html"), "Logout failed");
    }
