...
public class saucedemo {
    ...
    public void testSortingDropdown() {
        ...
        // Test Name (A to Z)
        WebElement dropdownElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("product_sort_container")));
        ...
        // Test Name (Z to A)
        dropdownElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("product_sort_container")));
    ...
    public void testMenuNavigation() {
        ...
        // Close menu if open
        List<WebElement> menuCloseButton = driver.findElements(By.id("react-burger-cross-btn"));
        if (menuCloseButton.size() > 0 && menuCloseButton.get(0).isDisplayed()) {
            menuCloseButton.get(0).click();
