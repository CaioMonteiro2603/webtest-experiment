...
public class saucedemo{
    ...
    public void testItemSorting() {
        ...
        List<WebElement> items = wait.until(ExpectedConditions.visibilityOfNestedElementsLocatedBy(
            driver.findElement(By.className("inventory_list")), By.cssSelector(".inventory_item_name")));
        ...
        sortDropdown = new Select(wait.until(ExpectedConditions.elementToBeClickable(
            By.cssSelector("select.product_sort_container"))));
        sortDropdown.selectByValue("za");
        items = wait.until(ExpectedConditions.visibilityOfNestedElementsLocatedBy(
            driver.findElement(By.className("inventory_list")), By.cssSelector(".inventory_item_name")));
        ...
        items = wait.until(ExpectedConditions.visibilityOfNestedElementsLocatedBy(
            driver.findElement(By.className("inventory_list")), By.cssSelector(".inventory_item_price")));
