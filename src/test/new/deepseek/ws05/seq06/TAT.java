...
public class TAT {
    ...
    public void testProductLinks() {
        driver.get(BASE_URL);
        WebElement productLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='produtos.html']")));
        productLink.click();
    ...
    public void testContactLink() {
        driver.get(BASE_URL);
        WebElement contactLink = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href*='contato.html']")));
        contactLink.click();
