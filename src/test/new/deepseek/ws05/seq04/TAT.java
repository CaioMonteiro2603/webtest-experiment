...
public class TAT {
    ...
    public void testSuccessfulLogin() {
        driver.get(BASE_URL);
        WebElement usernameField = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("input[ng-model='user.name']")));
    ...
    public void testCreateEmployee() {
        ...
        WebElement createButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[id='bAdd']")));
        createButton.click();
    ...
    public void testEditEmployee() {
        ...
        WebElement editButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[id='bEdit']")));
        editButton.click();
    ...
    public void testDeleteEmployee() {
        ...
        WebElement deleteButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[id='bDelete']")));
        deleteButton.click();
    ...
    public void testLogout() {
        ...
        WebElement logoutButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("p.main-button")));
        logoutButton.click();
