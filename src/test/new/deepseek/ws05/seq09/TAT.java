...
public class TAT {
    ...
    public void testPageLoad() {
        ...
        WebElement formTitle = wait.until(ExpectedConditions.presenceOfElementLocated(
            By.cssSelector("h1")));
        assertEquals("CAC TAT", formTitle.getText(), "Page title should match");
    }
    ...
    public void testPhoneFieldValidation() {
        ...
        WebElement errorMessage = wait.until(ExpectedConditions.presenceOfElementLocated(
            By.cssSelector(".phone-error")));
        assertTrue(errorMessage.isDisplayed(), "Should show phone validation error");
    }
    ...
    public void testProductSelection() {
        ...
        productDropdown.selectByValue("cursos");
        assertEquals("cursos", productDropdown.getFirstSelectedOption().getAttribute("value"),
            "Should select courses option");
        
        productDropdown.selectByValue("mentoria");
        assertEquals("mentoria", productDropdown.getFirstSelectedOption().getAttribute("value"),
