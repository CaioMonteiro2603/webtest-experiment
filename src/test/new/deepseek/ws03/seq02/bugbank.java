...
public class bugbank {
    ...
    public void testValidLogin() {
        ...
        WebElement welcomeMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(
            By.cssSelector(".home__Timeline-sc-1icemtq-7")));
    ...
    private void login() {
        ...
        if (driver.findElements(By.cssSelector("form")).size() > 0) {
            ...
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".home__Timeline-sc-1icemtq-7")));
        }
    }
}