...
public class bugbank  {
    ...
    public void testValidLogin() {
        ...
        WebElement welcomeMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[contains(text(),'Saldo')]")));
    ...
    public void testInvalidLogin() {
        ...
        WebElement errorMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[contains(text(),'Email ou senha incorretos')]")));
    ...
    public void testTransferMoney() {
        ...
        WebElement accountNumber = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("input[placeholder='Conta']")));
        WebElement transferAmount = driver.findElement(By.cssSelector("input[placeholder='Digite o valor']"));
        WebElement transferDescription = driver.findElement(By.cssSelector("input[placeholder='Descrição']"));
        WebElement confirmButton = driver.findElement(By.xpath("//button[contains(text(),'Transferir')]"));
        ...
        WebElement confirmationMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[contains(text(),'Transferência realizada')]")));
    ...
    public void testTransactionHistory() {
        ...
        WebElement transactionList = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".extract__container")));
    ...
    public void testLogout() {
        ...
        WebElement loginForm = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("input[type='email']")));
    ...
    public void testSocialLinks() {
        ...
        // Test Facebook link
        WebElement facebookLink = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(@href,'facebook')]")));
        facebookLink.click();
