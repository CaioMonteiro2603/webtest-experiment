...
public class bugbank  {
    ...
    public void testSuccessfulLogin() {
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(".dashboard")));
    ...
    public void testInvalidLogin() {
        ...
        WebElement error = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[contains(text(), 'Usuário ou senha inválido')]")));
    ...
    public void testTransferOperation() {
        ...
        WebElement success = wait.until(ExpectedConditions.presenceOfElementLocated(
            By.xpath("//*[contains(text(), 'Transferência realizada com sucesso')]")));
    ...
    public void testLogout() {
        ...
        WebElement logout = wait.until(ExpectedConditions.elementToBeClickable(
            By.xpath("//*[contains(text(), 'Sair') or contains(text(), 'Logout') or @class='logout']")));
        logout.click();
