...
public class bugbank {
    ...
    public void testValidLogin() {
        ...
        WebElement dashboardHeader = wait.until(ExpectedConditions.presenceOfElementLocated(
            By.xpath("//h1[contains(text(), 'Bem vindo')]")));
        Assertions.assertTrue(dashboardHeader.isDisplayed(), "Login failed - dashboard not displayed");
    }
    ...
    public void testLogout() {
        ...
        WebElement loginForm = driver.findElement(By.cssSelector("button[type='submit']"));
    ...
    private void loginIfNeeded() {
        WebElement dashboardHeader = driver.findElement(By.tagName("body"));
        if (!dashboardHeader.getText().contains("Bem vindo")) {
            driver.get(BASE_URL);
            WebElement email = wait.until(ExpectedConditions.presenceOfElementLocated(By.name("email")));
            WebElement password = driver.findElement(By.name("password"));
            WebElement loginButton = driver.findElement(By.cssSelector("button[type='submit']"));
