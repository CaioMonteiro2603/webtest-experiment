...
public class BrasilAgritest {
    ...
    public void testNavigationMenu() {
        ...
        WebElement farmsLink = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(@href, 'farms') or contains(text(), 'Fazendas')]")));
        farmsLink.click();
        wait.until(ExpectedConditions.urlContains("fazendas"));
        Assertions.assertTrue(driver.findElement(By.tagName("h1")).getText().contains("Fazendas"), "Should navigate to Farms page");

        WebElement reportsLink = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(@href, 'reports') or contains(text(), 'Relatórios')]")));
        reportsLink.click();
        wait.until(ExpectedConditions.urlContains("relatorios"));
    ...
    public void testFarmCreation() {
        ...
        WebElement farmsLink = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(@href, 'fazendas') or contains(text(), 'Fazendas')]")));
        farmsLink.click();
        wait.until(ExpectedConditions.urlContains("fazendas"));
        
        WebElement newFarmButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[contains(text(), 'Nova') or @id='new-farm-btn']")));
        newFarmButton.click();
    ...
    public void testLogout() {
        ...
        WebElement userMenu = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[contains(@class, 'menu') or contains(@class, 'user') or //a[contains(@href, 'logout')]]")));
        userMenu.click();
        
        WebElement logoutButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(text(), 'Sair') or contains(@href, 'logout')]")));
        logoutButton.click();
