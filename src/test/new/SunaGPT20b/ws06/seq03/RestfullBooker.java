...
public class RestfullBooker {
    ...
    public void testFooterSocialLinks() {
        ...
        WebElement twitterLink = wait.until(
                ExpectedConditions.elementToBeClickable(By.cssSelector("a[data-test='social-twitter']")));
        twitterLink.click();
        switchToNewWindowAndValidate("twitter.com");

        // Facebook
        WebElement facebookLink = wait.until(
                ExpectedConditions.elementToBeClickable(By.cssSelector("a[data-test='social-facebook']")));
        facebookLink.click();
        switchToNewWindowAndValidate("facebook.com");

        // LinkedIn
        WebElement linkedInLink = wait.until(
                ExpectedConditions.elementToBeClickable(By.cssSelector("a[data-test='social-linkedin']")));
        linkedInLink.click();
