...
private void fillForm(String firstName, String lastName, String email,
    ...
    // Country dropdown - removed as element doesn't exist
    // Terms checkbox
    WebElement termsChk = driver.findElement(By.id("agree"));
...
public void testSuccessfulSubmission() {
    ...
    fillForm("Alice", "Smith", "alice.smith@example.com",
            "SecurePass123", "female", null, true);
    submitForm();
