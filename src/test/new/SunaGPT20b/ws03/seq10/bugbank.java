...
public class bugbank {
    ...
    private void ensureLoggedIn() {
        ...
        if (!loginButtons.isEmpty()) {
            ...
            userField = wait.until(ExpectedConditions.elementToBeClickable(userField));
            userField.clear();
    ...
    private void openMenu() {
        WebElement menuBtn = wait.until(
                ExpectedConditions.presenceOfElementLocated(By.id("react-burger-menu-btn")));
        menuBtn = wait.until(ExpectedConditions.elementToBeClickable(menuBtn));
        menuBtn.click();
    ...
    public void testSortingDropdown() {
        ...
        WebElement sortDropdown = wait.until(
                ExpectedConditions.presenceOfElementLocated(By.cssSelector("select[data-test='product_sort_container']")));
        sortDropdown = wait.until(ExpectedConditions.elementToBeClickable(sortDropdown));
    ...
    public void testAddToCartAndCheckout() {
        ...
        Assertions.assertTrue(addButtons.isEmpty(), "Add to cart button should be present");
