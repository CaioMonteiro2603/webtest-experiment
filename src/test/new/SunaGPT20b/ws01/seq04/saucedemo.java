...
public class saucedemo {
    ...
    public void testInvalidLogin() {
        ...
        Assertions.assertEquals(BASE_URL, driver.getCurrentUrl(), "URL changed after failed login.");
    }
    ...
    public void testMenuResetAppState() {
        ...
        Assertions.assertTrue(driver.findElements(By.className("shopping_cart_badge")).size() > 0,
