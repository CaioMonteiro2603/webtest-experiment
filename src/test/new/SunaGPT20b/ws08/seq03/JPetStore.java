...
public class JPetStore {
    ...
    private void login(String username, String password) {
        ...
        WebElement loginBtn = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button[type='submit'], input[type='submit'], button[name='loginButton'], input[name='loginButton']")));
        loginBtn.click();
    }
