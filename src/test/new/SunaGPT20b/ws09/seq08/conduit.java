...
public class conduit {
    ...
    public void testValidLogin() {
        ...
        WebElement newArticleLink = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("a[href='#/editor']")));
    ...
    public void testInvalidLogin() {
        ...
        Assertions.assertFalse(errorElements.isEmpty(), "Error message should be displayed for invalid login");
    }
    ...
    public void testOneLevelInternalAndExternalLinks() {
        ...
        for (int i = 0; i < anchors.size(); i++) {
            try {
                WebElement anchor = driver.findElements(By.cssSelector("a[href]")).get(i);
