...
public class conduit {
    ...
    private void logoutIfLoggedIn() {
        try {
            // Open menu if needed
            WebElement menuBtn = driver.findElement(By.cssSelector("button.navbar-toggler"));
            menuBtn.click();
    ...
    public void testInvalidLogin() {
        ...
        WebElement errorMsg = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".error-messages, .error-message, .alert-danger")));
    ...
    public void testMenuNavigation() {
        ...
        login("demo@realworld.io", "demo");
        // Open burger menu
        WebElement menuBtn = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button.navbar-toggler")));
        menuBtn.click();
        ...
        WebElement newPostLink = driver.findElement(By.linkText("New Article"));
    ...
    public void testArticleNavigation() {
        ...
        List<WebElement> articles = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.cssSelector("h1")));
