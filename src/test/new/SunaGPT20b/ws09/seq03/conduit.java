...
public class conduit {
    ...
    private void login(String email, String password) {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("a.nav-link")));
    }
    ...
    public void testValidLogin() {
        ...
        WebElement feedHeader = wait.until(
                ExpectedConditions.visibilityOfElementLocated(By.cssSelector("a.nav-link.active")));
    ...
    public void testInvalidLogin() {
        ...
        WebElement errorMsg = wait.until(
                ExpectedConditions.visibilityOfElementLocated(By.cssSelector("div.ng-scope")));
