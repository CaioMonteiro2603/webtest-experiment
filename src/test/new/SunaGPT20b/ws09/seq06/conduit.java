...
public class conduit {
    ...
    public void testValidLogin() {
        ...
        // Wait for user-specific links to appear
        wait.until(ExpectedConditions.presenceOfElementLocated(By.linkText("New Post")));
    ...
    public void testInvalidLogin() {
        ...
        // Wait for error message with updated selector
        WebElement error = waitVisible(By.cssSelector(".error-message, .error-messages"));
        Assertions.assertTrue(error.isDisplayed(), "Error message should be displayed for invalid credentials");
        Assertions.assertTrue(error.getText().toLowerCase().contains("email or password") || 
    ...
    public void testUserMenuNavigation() {
        ...
        // Wait for New Post link to be clickable
        wait.until(ExpectedConditions.presenceOfElementLocated(By.linkText("New Post")));
    ...
    public void testArticleNavigation() {
        ...
        wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.cssSelector("a.preview-link, .article-meta a")));
        // Click the first article preview link
        List<WebElement> articleLinks = driver.findElements(By.cssSelector("a.preview-link, .article-meta a"));
    ...
    public void testTagFilter() {
        ...
        // Find first tag link
        List<WebElement> tags = driver.findElements(By.cssSelector("a.tag-default, a.tag-pill"));
        ...
        List<WebElement> filteredTags = driver.findElements(By.cssSelector("a.tag-default, a.tag-pill"));
