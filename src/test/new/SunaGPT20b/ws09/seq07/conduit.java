...
public class conduit {
    ...
    public void testValidLogin() {
        ...
        WebElement yourFeed = wait.until(
                ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[contains(@class,'nav-link') and contains(text(),'Your Feed')]")));
    ...
    public void testNavigationMenu() {
        ...
        WebElement newArticle = wait.until(
                ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(@href,'#/editor')]")));
        newArticle.click();
        ...
        WebElement settings = wait.until(
                ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(@href,'#/settings')]")));
        settings.click();
        ...
        WebElement signOut = wait.until(
                ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(@href,'#')]")));
        signOut.click();
