...
public class BrasilAgritest {
    ...
    private void ensureLoggedIn() {
        if (!driver.getCurrentUrl().contains("gestao.brasilagritest.com")) {
    ...
    public void testValidLogin() {
        login(USER_EMAIL, USER_PASSWORD);
        Assertions.assertTrue(driver.getCurrentUrl().contains("gestao.brasilagritest.com"),
                "Login failed: main page not loaded.");
    }
    ...
    public void testMenuAllItems() {
        ...
        wait.until(ExpectedConditions.urlContains("gestao.brasilagritest.com"));
        Assertions.assertTrue(driver.getCurrentUrl().contains("gestao.brasilagritest.com"),
                "All Items link did not navigate to main page.");
        closeMenuIfOpen();
    }
    ...
    public void testMenuLogout() {
        ...
        wait.until(ExpectedConditions.urlContains("gestao.brasilagritest.com"));
        Assertions.assertTrue(driver.getCurrentUrl().contains("gestao.brasilagritest.com"),
                "Logout did not return to main page.");
    }
