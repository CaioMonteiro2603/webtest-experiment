...
public class JSFiddle {
    ...
    public void testBasePageLoads() {
        driver.get(BASE_URL);
        org.junit.jupiter.api.Assertions.assertTrue(driver.getTitle().toLowerCase().contains("jsfiddle"),
    ...
    public void testInternalLinks() {
        for (String link : internalLinks) {
            ...
            String pageTitle = wait.until(driver -> !driver.getTitle().isEmpty() ? driver.getTitle() : null);
            org.junit.jupiter.api.Assertions.assertFalse(pageTitle.isEmpty(),
    ...
    public void testExternalLinks() {
        ...
        for (String link : externalLinks) {
            ...
            try {
                ...
                String expectedHost = new URL(link).getHost().toLowerCase();
                
                // Handle potential redirects to different subdomains
                if (expectedHost.equals("jsfiddle.gitbook.io") && 
                    url.getHost().toLowerCase().equals("docs.jsfiddle.net")) {
                    // This is expected behavior - docs.jsfiddle.net is the current docs URL
                    continue;
                }
                
                org.junit.jupiter.api.Assertions.assertEquals(expectedHost,
                        url.getHost().toLowerCase(),
                        "External link should navigate to the expected domain");
            } catch (MalformedURLException e) {
                org.junit.jupiter.api.Assertions.fail("Malformed URL encountered: " + currentUrl);
            }
