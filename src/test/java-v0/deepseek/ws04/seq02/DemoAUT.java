...
public class DemoAUT {
    ...
    public void testFormSubmission() {
        ...
        new Select(role).selectByVisibleText("Technical Lead");
    ...
    public void testDropdownSelection() {
        ...
        roleDropdown.selectByVisibleText("Technical Lead");
        Assertions.assertEquals("Technical Lead", roleDropdown.getFirstSelectedOption().getText(),
            "Expected role to be 'Technical Lead'");

        roleDropdown.selectByVisibleText("QA Engineer");
        Assertions.assertEquals("QA Engineer", roleDropdown.getFirstSelectedOption().getText(),
            "Expected role to be 'QA Engineer'");
    }
