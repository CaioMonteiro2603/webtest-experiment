...
public class bugbank  {
    ...
    public void testRegisterAndLogin() {
        ...
        WebElement registerTab = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button[id='register']")));
        registerTab.click();
    ...
    public void testTransferFunds() {
        ...
        String balanceBefore = driver.findElement(By.cssSelector(".home__Text-sc-1auj767-8")).getText();
        ...
        String balanceAfter = driver.findElement(By.cssSelector(".home__Text-sc-1auj767-8")).getText();
