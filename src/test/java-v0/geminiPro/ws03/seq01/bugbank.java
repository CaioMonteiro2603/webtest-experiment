...
public class bugbank {
    ...
    private static final By BALANCE_TOGGLE = By.className("style__ToggleLabel-sc-15y2mqg-0");
    ...
    void testSuccessfulLogin() {
        ...
        Assertions.assertTrue(driver.getCurrentUrl().endsWith("/home"), "URL did not navigate to /home after login.");
    ...
    void testSuccessfulTransfer() {
        // This test assumes the user is already logged in from the previous test.
        Assertions.assertTrue(driver.getCurrentUrl().endsWith("/home"), "Test must start from the home page.");
    ...
    void testViewStatement() {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(BACK_BUTTON)).click();
        wait.until(ExpectedConditions.urlContains("/home"));
        Assertions.assertTrue(driver.getCurrentUrl().endsWith("/home"), "Did not return to the home page from statement.");
    }
