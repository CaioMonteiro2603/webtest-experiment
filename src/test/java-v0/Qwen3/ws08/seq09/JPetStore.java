...
public class JPetStore {
    ...
    void testHomePageLoadsSuccessfully() {
        ...
        WebElement mainTitle = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("div.title>h2")));
    ...
    void testNavigationToSignInPage() {
        ...
        WebElement loginForm = wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("accountForm")));
    ...
    void testAboutThisWebsiteLink() {
        ...
        WebElement aboutLink = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("About This Website")));
        aboutLink.click();
