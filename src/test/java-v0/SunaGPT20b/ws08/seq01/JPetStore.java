...
public class JPetStore {
    ...
    public void testCategoryNavigation() {
        ...
        for (WebElement link : categoryLinks) {
            ...
            link.click();
            wait.until(ExpectedConditions.urlContains("viewCategory"));
            WebElement productTable = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("table")));
    ...
    public void testProductDetailPage() {
        ...
        WebElement firstCategory = wait.until(ExpectedConditions.elementToBeClickable(
                By.cssSelector("a[href*='viewCategory']")));
        firstCategory.click();
        wait.until(ExpectedConditions.urlContains("viewCategory"));
