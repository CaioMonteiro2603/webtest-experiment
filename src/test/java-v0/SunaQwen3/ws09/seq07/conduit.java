...
public class conduit {
    ...
    void testValidLogin() {
        ...
        assertTrue(driver.getCurrentUrl().contains("/editor"), "Should be redirected to editor page after login");
    }
    ...
    void testFooterTwitterLink() {
        ...
        WebElement twitterLink = driver.findElement(By.cssSelector("a[href='https://twitter.com/gothinkster']"));
        twitterLink.click();
    ...
    void testFooterFacebookLink() {
        driver.get(BASE_URL);
        String originalWindow = driver.getWindowHandle();
        WebElement facebookLink = driver.findElement(By.cssSelector("a[href='https://www.facebook.com/thinkster.io']"));
        facebookLink.click();
    ...
    void testFooterLinkedInLink() {
        driver.get(BASE_URL);
        String originalWindow = driver.getWindowHandle();
        WebElement linkedinLink = driver.findElement(By.cssSelector("a[href='https://www.linkedin.com/company/thinkster-io']"));
        linkedinLink.click();
