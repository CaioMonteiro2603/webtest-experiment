...
public class DemoAUT {
    ...
    public void testRequiredFields() {
        ...
        Assertions.assertFalse(requiredFields.isEmpty(), "Form should have required fields.");
    ...
    public void testExternalLinks() {
        ...
        Assertions.assertFalse(links.isEmpty(), "There should be at least one external link.");
        ...
        for (WebElement link : links) {
            ...
            // Click external link
            driver.switchTo().frame(driver.findElement(By.tagName("body")));
            link.click();
