...
public class JPetStore {
    ...
    private void navigateToRegister() {
        List<WebElement> registerLinks = driver.findElements(By.linkText("Register New Account"));
    ...
    public void testCategoryNavigationAndSorting() {
        ...
        List<WebElement> categoryLinks = driver.findElements(By.xpath("//a[contains(@href, '/product/ws') or contains(@href, '/product') and not(@href='') ]"));
