...
public class JPetStore{
    ...
    public void testValidLoginAndNavigateToHome() {
        ...
        assertFalse(driver.findElements(By.cssSelector(".productList")).isEmpty(),
    ...
    public void testBurgerMenuOptions() {
        ...
        // Reset App State
        WebElement resetLink = findElement("a[href*='resetShoppingCart'], button#resetCart");
        if (resetLink != null) {
            resetLink.click();
            wait.until(ExpectedConditions.invisibilityOfElementLocated(
                    By.cssSelector(".cartCount, .shopping_cart_badge")));
    ...
    public void testAddToCartAndCheckout() {
        ...
        WebElement cartIcon = findElement(".cartIcon, .shopping_cart");
        ...
        // Go to cart
        WebElement cartLink = findElement("a[href*='cart'], button#cart");
        cartLink.click();
        wait.until(ExpectedConditions.urlContains("cart"));

        // Verify cart has the item
        List<WebElement> cartItems = driver.findElements(By.cssSelector(".cartItem, tr.cart_row"));
        assertFalse(cartItems.isEmpty(), "Cart should contain at least one item");

        // Proceed to checkout
        WebElement checkoutBtn = wait.until(ExpectedConditions.elementToBeClickable(
                By.cssSelector("button#checkout, a[href*='checkout']")));
        checkoutBtn.click();

        // Fill payment details (simple: use placeholders if any)
        WebElement firstName = findElement("input[name='firstName'], input#firstName");
        WebElement lastName = findElement("input[name='lastName'], input#lastName");
        WebElement address = findElement("input[name='address'], input#address");
        WebElement continueBtn = wait.until(ExpectedConditions.elementToBeClickable(
                By.cssSelector("button#continue, button[type='submit']")));
        ...
        WebElement finishBtn = wait.until(ExpectedConditions.elementToBeClickable(
                By.cssSelector("button#finish, button[type='submit']")));
        finishBtn.click();

        // Assert success message
        WebElement successMsg = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.cssSelector(".orderConfirmation, .complete-header")));
