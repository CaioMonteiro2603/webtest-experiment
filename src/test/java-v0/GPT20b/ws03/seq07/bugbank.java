...
public class bugbank {
    ...
    private void login() {
        ...
        Assertions.assertTrue(driver.getCurrentUrl().contains("inventory"),
                "Expected to navigate to inventory page after login");
    }
    ...
    public void testSortingOptions() {
        ...
        WebElement sortDropdown = wait.until(
                ExpectedConditions.elementToBeClickable(
                        By.cssSelector("select#sortDropdown")));
        sortDropdown.click();
    ...
    public void testAddRemoveCart() {
        ...
        WebElement firstAdd = wait.until(
                ExpectedConditions.elementToBeClickable(
                        By.cssSelector("button[data-action='add']")));
        firstAdd.click();
        ...
        WebElement firstRemove = wait.until(
                ExpectedConditions.elementToBeClickable(
                        By.cssSelector("button[data-action='remove']")));
        firstRemove.click();
