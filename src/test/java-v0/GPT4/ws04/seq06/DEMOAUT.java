...
public class DEMOAUT {
    ...
    public void testPageTitle() {
        ...
        Assertions.assertEquals("Sample Form", title, "Page title should be 'Sample Form'");
    }
    ...
    public void testFormSubmissionWithMissingFields() {
        ...
        Assertions.assertTrue(alertText.toLowerCase().contains("please fill"), "Alert should prompt to fill mandatory fields.");
    }
