...
public class DEMOAUT {
    ...
    public void testPageLoad() {
        ...
        Assertions.assertEquals("This is a sample form", header.getText(), "Header text mismatch");
    }
    ...
    public void testRequiredFieldsValidation() {
        ...
        List<WebElement> invalidFields = driver.findElements(By.cssSelector(":invalid"));
        Assertions.assertFalse(invalidFields.isEmpty(), "Expected validation errors for empty required fields");
    }
