...
public class parabank {
    ...
    public void testHomePageLoads() {
        driver.get(BASE_URL);
        WebElement header = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("h1.title")));
    ...
    public void testInvalidLogin() {
        ...
        Assertions.assertTrue(error.getText().toLowerCase().contains("error"), "Should display error for invalid login");
    }
    ...
    public void testValidLogin() {
        ...
        WebElement accountsOverview = wait.until(ExpectedConditions.visibilityOfElementLocated(By.linkText("Accounts Overview")));
    ...
    public void testAccountsOverviewPage() {
        ...
        WebElement heading = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("h1.title")));
