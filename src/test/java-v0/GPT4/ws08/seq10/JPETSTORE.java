...
public class JPETSTORE {
    ...
    private void openBase() {
        driver.get(BASE_URL);
        wait.until(ExpectedConditions.presenceOfElementLocated(By.id("LogoContent")));
    ...
    public void testHomePageLoads() {
        ...
        Assertions.assertTrue(driver.findElement(By.id("LogoContent")).isDisplayed(), "Logo should be visible");
    }
