...
public class DemoAUT {
    ...
    public void testFormPageLoads() {
        driver.get(BASE_URL);
        Assertions.assertEquals("Form", driver.getTitle());
    }
    ...
    public void testFormSubmission() {
        ...
        WebElement development = driver.findElement(By.cssSelector("input[name='development'][value='web']"));
        development.click();
    ...
    public void testRequiredFieldValidation() {
        ...
        List<WebElement> errorMessages = driver.findElements(By.cssSelector(".text-danger"));
    ...
    public void testPasswordValidation() {
        ...
        Assertions.assertTrue(passwordError.isDisplayed(), "Password validation error should be displayed");
    }
    ...
    public void testRadioButtonSelection() {
        ...
        WebElement webDev = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("input[name='development'][value='web']")));
        webDev.click();
        Assertions.assertTrue(webDev.isSelected(), "Web development should be selected");
        
        WebElement mobileDev = driver.findElement(By.cssSelector("input[name='development'][value='mobile']"));
        mobileDev.click();
        Assertions.assertTrue(mobileDev.isSelected(), "Mobile development should be selected");
        Assertions.assertFalse(webDev.isSelected(), "Web development should be deselected");
    }
