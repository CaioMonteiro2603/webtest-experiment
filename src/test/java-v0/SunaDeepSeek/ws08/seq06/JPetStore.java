...
public class JPetStore {
    ...
    public void testFishCategoryNavigation() {
        ...
        WebElement fishCategory = wait.until(
            ExpectedConditions.elementToBeClickable(By.cssSelector("div#MainImageContent area[alt='Fish']")));
        fishCategory.click();
    ...
    public void testProductDetailsPage() {
        ...
        WebElement productLink = wait.until(
            ExpectedConditions.elementToBeClickable(By.linkText("FI-SW-01")));
        productLink.click();
    ...
    public void testItemPageAndAddToCart() {
        ...
        WebElement itemLink = wait.until(
            ExpectedConditions.elementToBeClickable(By.linkText("EST-1")));
        itemLink.click();
    ...
    public void testSignInAndOut() {
        ...
        WebElement signInBtn = driver.findElement(By.name("signon"));
        signInBtn.click();
